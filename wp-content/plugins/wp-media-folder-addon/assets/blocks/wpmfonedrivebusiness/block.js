...
(function (wpI18n, wpBlocks, wpElement, wpEditor, wpComponents) {
    ...
    var WpmfOnedriveBusiness = function (_Component) {
        _inherits(WpmfOnedriveBusiness, _Component);

        function WpmfOnedriveBusiness() {
            _classCallCheck(this, WpmfOnedriveBusiness);

            var _this = _possibleConstructorReturn(this, (WpmfOnedriveBusiness.__proto__ || Object.getPrototypeOf(WpmfOnedriveBusiness)).apply(this, arguments));
        ...
        _createClass(WpmfOnedriveBusiness, [{
            key: 'openModal',
            ...
            value: function addEventListener(e) {
                ...
                if (e.data.type !== 'wpmfonedrivebusinessinsert') {
                    return;
                }
            ...
            value: function render() {
                ...
                return React.createElement(
                    ...
                    hasfiles && React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(IconButton, {
                                ...
                                label: wpmfodvbusinessblocks.l18n.remove,
                                icon: 'no',
                    ...
                    !hasfiles && React.createElement(
                        ...
                        wpmfodvbusinessblocks.l18n.btnopen
                    )
                );
            }
        }]);

        return WpmfOnedriveBusiness;
    }(Component);
    ...
    registerBlockType('wpmf/block-onedrive-business-file', {
        title: wpmfodvbusinessblocks.l18n.onedrive_drive,
