...
use WP_Media_Folder\Aws\CloudTrail\Exception\CloudTrailException;

/**
 * The `WP_Media_Folder\Aws\CloudTrail\LogFileIterator` provides an easy way to iterate over
