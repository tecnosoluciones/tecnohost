 ...
 * WP_Media_Folder\Aws\ResultInterface and WP_Media_Folder\Aws\Exception\AwsException objects.
 */
class MockHandler implements \Countable
{
    ...
    /**
     * The passed in value must be an array of {@see WP_Media_Folder\Aws\ResultInterface} or
    ...
    public function append()
    {
        foreach (func_get_args() as $value) {
            if ($value instanceof ResultInterface
                ...
                throw new \InvalidArgumentException('Expected an WP_Media_Folder\Aws\ResultInterface or WP_Media_Folder\Aws\Exception\AwsException.');
            }
        }
    }
