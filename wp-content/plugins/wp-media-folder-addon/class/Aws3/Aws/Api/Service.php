...
class Service extends AbstractModel
{
    ...
    {
        static $mapping = [
            'json'      => 'WP_Media_Folder\Aws\Api\Serializer\JsonRpcSerializer',
            'query'     => 'WP_Media_Folder\Aws\Api\Serializer\QuerySerializer',
            'rest-json' => 'WP_Media_Folder\Aws\Api\Serializer\RestJsonSerializer',
            'rest-xml'  => 'WP_Media_Folder\Aws\Api\Serializer\RestXmlSerializer'
        ];
    ...
    {
        static $mapping = [
            'json'      => 'WP_Media_Folder\Aws\Api\ErrorParser\JsonRpcErrorParser',
            'query'     => 'WP_Media_Folder\Aws\Api\ErrorParser\XmlErrorParser',
            'rest-json' => 'WP_Media_Folder\Aws\Api\ErrorParser\RestJsonErrorParser',
            'rest-xml'  => 'WP_Media_Folder\Aws\Api\ErrorParser\XmlErrorParser',
            'ec2'       => 'WP_Media_Folder\Aws\Api\ErrorParser\XmlErrorParser'
        ];
    ...
    {
        static $mapping = [
            'json'      => 'WP_Media_Folder\Aws\Api\Parser\JsonRpcParser',
            'query'     => 'WP_Media_Folder\Aws\Api\Parser\QueryParser',
            'rest-json' => 'WP_Media_Folder\Aws\Api\Parser\RestJsonParser',
            'rest-xml'  => 'WP_Media_Folder\Aws\Api\Parser\RestXmlParser'
        ];
