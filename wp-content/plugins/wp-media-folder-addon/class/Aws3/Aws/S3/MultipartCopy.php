...
class MultipartCopy extends AbstractUploadManager
{
     ...
     *   signature like `function (WP_Media_Folder\Aws\Command $command) {...}`.
     * - before_upload: (callable) Callback to invoke before `UploadPartCopy`
     *   operations. The callback should have a function signature like
     *   `function (WP_Media_Folder\Aws\Command $command) {...}`.
     ...
     * - state: (WP_Media_Folder\Aws\Multipart\UploadState) An object that represents the state
     *   of the multipart upload and that is used to resume a previous upload.
     *   When this option is provided, the `bucket`, `key`, and `part_size`
     *   options are ignored.
     * - source_metadata: (WP_Media_Folder\Aws\ResultInterface) An object that represents the
