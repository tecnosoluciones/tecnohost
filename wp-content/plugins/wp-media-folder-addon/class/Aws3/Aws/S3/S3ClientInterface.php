...
interface S3ClientInterface extends AwsClientInterface
{
     ...
     * use the {@see \WP_Media_Folder\Aws\S3\S3Client::createPresignedRequest} method and get
     ...
     * @param array  $options WP_Media_Folder\Aws\S3\BatchDelete options array.
     *
     * @see WP_Media_Folder\Aws\S3\S3Client::listObjects
     ...
     *   function signature like `function (WP_Media_Folder\Aws\Command $command) {...}`.
     ...
     *
     * @see WP_Media_Folder\Aws\S3\MultipartUploader for more info about multipart uploads.
     ...
     * @param array  $options       Options used to configure the upload process.
     *
     * @see WP_Media_Folder\Aws\S3\MultipartCopy for more info about multipart uploads.
     ...
     * @param array  $options   Options available in WP_Media_Folder\Aws\S3\Transfer::__construct
     *
     * @see WP_Media_Folder\Aws\S3\Transfer for more options and customization
     */
