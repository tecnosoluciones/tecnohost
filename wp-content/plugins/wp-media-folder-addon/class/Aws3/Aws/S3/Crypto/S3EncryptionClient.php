...
class S3EncryptionClient extends AbstractCryptoClient
{
     ...
     *   determined.
     *
     * @return \WP_Media_Folder\Aws\Result PutObject call result with the details of uploading
     *                     the encrypted file.
     *
     * @throws \InvalidArgumentException Thrown when arguments above are not
     *                                   passed or are passed incorrectly.
     ...
     *            using cbc.
     *
     * @return \WP_Media_Folder\Aws\Result GetObject call result with the 'Body' field
