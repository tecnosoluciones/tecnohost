...
class Transfer implements PromisorInterface
{
     ...
     *   callback accepts a single argument: WP_Media_Folder\Aws\CommandInterface $command.
    ...
    private function createDownloadPromise()
    {
        ...
        return (new WP_Media_Folder\Aws\CommandPool($this->client, $commands, [
    ...
    private function getUploadsIterator()
    {
        if (is_string($this->source)) {
            return WP_Media_Folder\Aws\filter(
                WP_Media_Folder\Aws\recursive_dir_iterator($this->sourceMetadata['path']),
