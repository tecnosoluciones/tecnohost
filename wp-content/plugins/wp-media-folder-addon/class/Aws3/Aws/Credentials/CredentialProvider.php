 ...
 * promise that is fulfilled with an {@see \WP_Media_Folder\Aws\Credentials\CredentialsInterface}
 * or rejected with an {@see \WP_Media_Folder\Aws\Exception\CredentialsException}.
 *
 * <code>
 ...
 * {@see WP_Media_Folder\Aws\Credentials\CredentialProvider::chain}. This function accepts
...
class CredentialProvider
{
     ...
     * instance of WP_Media_Folder\Aws\CacheInterface. Forwards calls when no credentials found
     ...
     * @see WP_Media_Folder\Aws\Credentials\InstanceProfileProvider for $config details.
     */
     ...
     * @see WP_Media_Folder\Aws\Credentials\EcsCredentialProvider for $config details.
     */
     ...
     * @param array $config Array of configuration data
     * @return callable
     * @see WP_Media_Folder\Aws\Credentials\AssumeRoleCredentialProvider for $config details.
     */
