...
class AwsClient implements AwsClientInterface
{
     ...
     *   waiter, or paginator.
     * - credentials:
     *   (WP_Media_Folder\Aws\Credentials\CredentialsInterface|array|bool|callable) Specifies
     *   the credentials used to sign requests. Provide an
     *   WP_Media_Folder\Aws\Credentials\CredentialsInterface object, an associative array of
     *   "key", "secret", and an optional "token" key, `false` to use null
     *   credentials, or a callable credentials provider used to create
     *   credentials or return null. See WP_Media_Folder\Aws\Credentials\CredentialProvider for
     ...
     *   WP_Media_Folder\GuzzleHttp\TransferStats). HTTP handlers must support an
     ...
     *   is required. See WP_Media_Folder\Aws\Endpoint\EndpointProvider for a list of built-in
     *   providers.
     * - handler: (callable) A handler that accepts a command object,
     *   request object and returns a promise that is fulfilled with an
     *   WP_Media_Folder\Aws\ResultInterface object or rejected with an
     *   WP_Media_Folder\Aws\Exception\AwsException. A handler does not accept a next handler
     ...
     *   WP_Media_Folder\Aws\Signature\SignatureProvider for a list of built-in providers
    ...
    private function parseClass()
    {
        ...
        return [
            strtolower($service),
            "WP_Media_Folder\Aws\\{$service}\\Exception\\{$service}Exception"
        ];
    }
