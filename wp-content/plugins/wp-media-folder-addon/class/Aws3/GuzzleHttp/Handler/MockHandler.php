...
class MockHandler implements \Countable
{
    ...
    public function __invoke(RequestInterface $request, array $options)
    {
        ...
        $response = $response instanceof \Exception
            ? \WP_Media_Folder\GuzzleHttp\Promise\rejection_for($response)
            : \WP_Media_Folder\GuzzleHttp\Promise\promise_for($response);
        ...
        return $response->then(
            function ($value) use ($request, $options) {
                ...
                if (isset($options['sink'])) {
                    ...
                    } elseif ($sink instanceof \WP_Media_Folder\Psr\Http\Message\StreamInterface) {
                        $sink->write($contents);
                    }
                }
        ...
        foreach (func_get_args() as $value) {
            if ($value instanceof ResponseInterface
                ...
                throw new \InvalidArgumentException('Expected a response or '
                    . 'exception. Found ' . \WP_Media_Folder\GuzzleHttp\describe_type($value));
            }
        }
    }
