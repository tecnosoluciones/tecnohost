...
class WpmfGoogle_Config
{
  ...
  /**
   * Create a new WpmfGoogle_Config. Can accept an ini file location with the
  ...
  public function __construct($ini_file_location = null)
  {
    $this->configuration = array(
      ...
      'auth_class'    => 'WpmfGoogle_Auth_OAuth2',
      'io_class'      => self::USE_AUTO_IO_SELECTION,
      'cache_class'   => 'WpmfGoogle_Cache_File',
      'logger_class'  => 'WpmfGoogle_Logger_Null',
      ...
      'classes' => array(
        'WpmfGoogle_IO_Abstract' => array(
          'request_timeout_seconds' => 100,
        ),
        'WpmfGoogle_Logger_Abstract' => array(
          'level' => 'debug',
          'log_format' => "[%datetime%] %level%: %message% %context%\n",
          'date_format' => 'd/M/Y:H:i:s O',
          'allow_newlines' => true
        ),
        'WpmfGoogle_Logger_File' => array(
          'file' => 'php://stdout',
          'mode' => 0640,
          'lock' => false,
        ),
        'WpmfGoogle_Http_Request' => array(
        ...
        'WpmfGoogle_Service_Exception' => array(
          'retry_map' => array(
        ...
        'WpmfGoogle_Cache_File' => array(
          'directory' => sys_get_temp_dir() . '/WpmfGoogle_Client'
        )
      ),
    );
   ...
   * the hd values within an id token (@see WpmfGoogle_Auth_LoginTicket) after sign
