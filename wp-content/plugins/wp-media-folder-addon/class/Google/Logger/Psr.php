 ...
 * with the `WpmfGoogle_Logger_Psr::setLogger()` method.
 */
class WpmfGoogle_Logger_Psr extends WpmfGoogle_Logger_Abstract
{
  /**
   ...
   */
  public function __construct(WpmfGoogle_Client $client, /*Psr\Log\LoggerInterface*/ $logger = null)
  {
