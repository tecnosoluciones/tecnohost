 ...
 * @author Google, Inc.
 */
class WpmfGoogle_Service_CivicInfo extends WpmfGoogle_Service
{
  ...
  public function __construct(WpmfGoogle_Client $client)
  {
    ...
    $this->divisions = new WpmfGoogle_Service_CivicInfo_Divisions_Resource(
        $this,
        $this->serviceName,
        'divisions',
        array(
    ...
    $this->elections = new WpmfGoogle_Service_CivicInfo_Elections_Resource(
        $this,
        $this->serviceName,
        'elections',
        array(
    ...
    $this->representatives = new WpmfGoogle_Service_CivicInfo_Representatives_Resource(
        $this,
        $this->serviceName,
        'representatives',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $civicinfoService = new WpmfGoogle_Service_CivicInfo(...);
 *   $divisions = $civicinfoService->divisions;
 *  </code>
 */
class WpmfGoogle_Service_CivicInfo_Divisions_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @return WpmfGoogle_Service_CivicInfo_DivisionSearchResponse
   */
  public function search($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('search', array($params), "WpmfGoogle_Service_CivicInfo_DivisionSearchResponse");
  }
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_CivicInfo_Elections_Resource extends WpmfGoogle_Service_Resource
{
   ...
   *
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_CivicInfo_ElectionsQueryResponse
   */
  public function electionQuery($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('electionQuery', array($params), "WpmfGoogle_Service_CivicInfo_ElectionsQueryResponse");
  }
   ...
   * @return WpmfGoogle_Service_CivicInfo_VoterInfoResponse
   */
  public function voterInfoQuery($address, $optParams = array())
  {
    $params = array('address' => $address);
    $params = array_merge($params, $optParams);
    return $this->call('voterInfoQuery', array($params), "WpmfGoogle_Service_CivicInfo_VoterInfoResponse");
  }
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_CivicInfo_Representatives_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @return WpmfGoogle_Service_CivicInfo_RepresentativeInfoResponse
   */
  public function representativeInfoByAddress($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('representativeInfoByAddress', array($params), "WpmfGoogle_Service_CivicInfo_RepresentativeInfoResponse");
  }
   ...
   * fulfilling one of these roles will be returned. Divisions that don't contain
   * a matching office will not be returned.
   * @return WpmfGoogle_Service_CivicInfo_RepresentativeInfoData
   */
  public function representativeInfoByDivision($ocdId, $optParams = array())
  {
    $params = array('ocdId' => $ocdId);
    $params = array_merge($params, $optParams);
    return $this->call('representativeInfoByDivision', array($params), "WpmfGoogle_Service_CivicInfo_RepresentativeInfoData");
  }
}
...
class WpmfGoogle_Service_CivicInfo_AdministrationRegion extends WpmfGoogle_Collection
{
  protected $collection_key = 'sources';
  protected $internal_gapi_mappings = array(
        "localJurisdiction" => "local_jurisdiction",
  );
  protected $electionAdministrationBodyType = 'WpmfGoogle_Service_CivicInfo_AdministrativeBody';
  protected $electionAdministrationBodyDataType = '';
  public $id;
  protected $localJurisdictionType = 'WpmfGoogle_Service_CivicInfo_AdministrationRegion';
  protected $localJurisdictionDataType = '';
  public $name;
  protected $sourcesType = 'WpmfGoogle_Service_CivicInfo_Source';
  protected $sourcesDataType = 'array';


  public function setElectionAdministrationBody(WpmfGoogle_Service_CivicInfo_AdministrativeBody $electionAdministrationBody)
  {
  ...
  public function setLocalJurisdiction(WpmfGoogle_Service_CivicInfo_AdministrationRegion $localJurisdiction)
  {
...
class WpmfGoogle_Service_CivicInfo_AdministrativeBody extends WpmfGoogle_Collection
{
  ...
  protected $correspondenceAddressType = 'WpmfGoogle_Service_CivicInfo_SimpleAddressType';
  protected $correspondenceAddressDataType = '';
  public $electionInfoUrl;
  protected $electionOfficialsType = 'WpmfGoogle_Service_CivicInfo_ElectionOfficial';
  ...
  public $name;
  protected $physicalAddressType = 'WpmfGoogle_Service_CivicInfo_SimpleAddressType';
  ...
  public function setCorrespondenceAddress(WpmfGoogle_Service_CivicInfo_SimpleAddressType $correspondenceAddress)
  {
  ...
  public function setPhysicalAddress(WpmfGoogle_Service_CivicInfo_SimpleAddressType $physicalAddress)
  {
...
class WpmfGoogle_Service_CivicInfo_Candidate extends WpmfGoogle_Collection
{
  protected $collection_key = 'channels';
  protected $internal_gapi_mappings = array(
  );
  public $candidateUrl;
  protected $channelsType = 'WpmfGoogle_Service_CivicInfo_Channel';
...
class WpmfGoogle_Service_CivicInfo_Channel extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class WpmfGoogle_Service_CivicInfo_Contest extends WpmfGoogle_Collection
{
  protected $collection_key = 'sources';
  protected $internal_gapi_mappings = array(
  );
  public $ballotPlacement;
  protected $candidatesType = 'WpmfGoogle_Service_CivicInfo_Candidate';
  protected $candidatesDataType = 'array';
  protected $districtType = 'WpmfGoogle_Service_CivicInfo_ElectoralDistrict';
  ...
  public function setDistrict(WpmfGoogle_Service_CivicInfo_ElectoralDistrict $district)
  {
...
class WpmfGoogle_Service_CivicInfo_DivisionSearchResponse extends WpmfGoogle_Collection
{
  protected $collection_key = 'results';
  protected $internal_gapi_mappings = array(
  );
  public $kind;
  protected $resultsType = 'WpmfGoogle_Service_CivicInfo_DivisionSearchResult';
...
class WpmfGoogle_Service_CivicInfo_DivisionSearchResult extends WpmfGoogle_Collection
{
...
class WpmfGoogle_Service_CivicInfo_Election extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $electionDay;
...
class WpmfGoogle_Service_CivicInfo_ElectionOfficial extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $emailAddress;
...
class WpmfGoogle_Service_CivicInfo_ElectionsQueryResponse extends WpmfGoogle_Collection
{
  protected $collection_key = 'elections';
  protected $internal_gapi_mappings = array(
  );
  protected $electionsType = 'WpmfGoogle_Service_CivicInfo_Election';
...
class WpmfGoogle_Service_CivicInfo_ElectoralDistrict extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class WpmfGoogle_Service_CivicInfo_GeographicDivision extends WpmfGoogle_Collection
{
...
class WpmfGoogle_Service_CivicInfo_Office extends WpmfGoogle_Collection
{
  protected $collection_key = 'sources';
  protected $internal_gapi_mappings = array(
  );
...
class WpmfGoogle_Service_CivicInfo_Official extends WpmfGoogle_Collection
{
  protected $collection_key = 'urls';
  protected $internal_gapi_mappings = array(
  );
  protected $addressType = 'WpmfGoogle_Service_CivicInfo_SimpleAddressType';
...
class WpmfGoogle_Service_CivicInfo_PollingLocation extends WpmfGoogle_Collection
{
  protected $collection_key = 'sources';
  protected $internal_gapi_mappings = array(
  );
  ...
  public function setAddress(WpmfGoogle_Service_CivicInfo_SimpleAddressType $address)
  {
    $this->address = $address;
  }
  public function getAddress()
...
class WpmfGoogle_Service_CivicInfo_RepresentativeInfoData extends WpmfGoogle_Collection
{
  protected $collection_key = 'officials';
  protected $internal_gapi_mappings = array(
  );
  protected $divisionsType = 'WpmfGoogle_Service_CivicInfo_GeographicDivision';
  protected $divisionsDataType = 'map';
  protected $officesType = 'WpmfGoogle_Service_CivicInfo_Office';
  protected $officesDataType = 'array';
  protected $officialsType = 'WpmfGoogle_Service_CivicInfo_Official';
...
class WpmfGoogle_Service_CivicInfo_RepresentativeInfoDataDivisions extends WpmfGoogle_Model
{
}

class WpmfGoogle_Service_CivicInfo_RepresentativeInfoResponse extends WpmfGoogle_Collection
{
  protected $collection_key = 'officials';
  protected $internal_gapi_mappings = array(
  );
  ...
  protected $divisionsDataType = 'map';
  public $kind;
  protected $normalizedInputType = 'WpmfGoogle_Service_CivicInfo_SimpleAddressType';
  ...
  public function setNormalizedInput(WpmfGoogle_Service_CivicInfo_SimpleAddressType $normalizedInput)
  {
...
class WpmfGoogle_Service_CivicInfo_RepresentativeInfoResponseDivisions extends WpmfGoogle_Model
{
}

class WpmfGoogle_Service_CivicInfo_SimpleAddressType extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $city;
...
class WpmfGoogle_Service_CivicInfo_Source extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $name;
...
class WpmfGoogle_Service_CivicInfo_VoterInfoResponse extends WpmfGoogle_Collection
{
  protected $collection_key = 'state';
  protected $internal_gapi_mappings = array(
  );
  protected $contestsType = 'WpmfGoogle_Service_CivicInfo_Contest';
  protected $contestsDataType = 'array';
  protected $dropOffLocationsType = 'WpmfGoogle_Service_CivicInfo_PollingLocation';
  protected $dropOffLocationsDataType = 'array';
  protected $earlyVoteSitesType = 'WpmfGoogle_Service_CivicInfo_PollingLocation';
  protected $earlyVoteSitesDataType = 'array';
  protected $electionType = 'WpmfGoogle_Service_CivicInfo_Election';
  protected $electionDataType = '';
  public $kind;
  protected $normalizedInputType = 'WpmfGoogle_Service_CivicInfo_SimpleAddressType';
  protected $normalizedInputDataType = '';
  protected $otherElectionsType = 'WpmfGoogle_Service_CivicInfo_Election';
  protected $otherElectionsDataType = 'array';
  protected $pollingLocationsType = 'WpmfGoogle_Service_CivicInfo_PollingLocation';
  protected $pollingLocationsDataType = 'array';
  public $precinctId;
  protected $stateType = 'WpmfGoogle_Service_CivicInfo_AdministrationRegion';
  ...
  public function setElection(WpmfGoogle_Service_CivicInfo_Election $election)
  {
