 ...
 * @author Google, Inc.
 */
class WpmfGoogle_Service_Reports extends WpmfGoogle_Service
{
  ...
  public function __construct(WpmfGoogle_Client $client)
  {
    ...
    $this->activities = new WpmfGoogle_Service_Reports_Activities_Resource(
        $this,
        $this->serviceName,
        'activities',
        array(
    ...
    $this->channels = new WpmfGoogle_Service_Reports_Channels_Resource(
        $this,
        $this->serviceName,
        'channels',
        array(
    ...
    $this->customerUsageReports = new WpmfGoogle_Service_Reports_CustomerUsageReports_Resource(
        $this,
        $this->serviceName,
    ...
    $this->userUsageReport = new WpmfGoogle_Service_Reports_UserUsageReport_Resource(
        $this,
        $this->serviceName,
        'userUsageReport',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $adminService = new WpmfGoogle_Service_Reports(...);
 *   $activities = $adminService->activities;
 *  </code>
 */
class WpmfGoogle_Service_Reports_Activities_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * be fetched.
   * @return WpmfGoogle_Service_Reports_Activities
   */
  public function listActivities($userKey, $applicationName, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "WpmfGoogle_Service_Reports_Activities");
  }
   ...
   * @opt_param string customerId Represents the customer for which the data is to
   * be fetched.
   * @return WpmfGoogle_Service_Reports_Channel
   */
  public function watch($userKey, $applicationName, WpmfGoogle_Service_Reports_Channel $postBody, $optParams = array())
  {
    $params = array('userKey' => $userKey, 'applicationName' => $applicationName, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('watch', array($params), "WpmfGoogle_Service_Reports_Channel");
  }
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_Reports_Channels_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   */
  public function stop(WpmfGoogle_Service_Reports_Channel $postBody, $optParams = array())
  {
 ...
 *  </code>
 */
class WpmfGoogle_Service_Reports_CustomerUsageReports_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @return WpmfGoogle_Service_Reports_UsageReports
   */
  public function get($date, $optParams = array())
  {
    $params = array('date' => $date);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WpmfGoogle_Service_Reports_UsageReports");
  }
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_Reports_UserUsageReport_Resource extends WpmfGoogle_Service_Resource
{
...
class WpmfGoogle_Service_Reports_Activities extends WpmfGoogle_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'WpmfGoogle_Service_Reports_Activity';
...
class WpmfGoogle_Service_Reports_Activity extends WpmfGoogle_Collection
{
  protected $collection_key = 'events';
  protected $internal_gapi_mappings = array(
  );
  protected $actorType = 'WpmfGoogle_Service_Reports_ActivityActor';
  protected $actorDataType = '';
  public $etag;
  protected $eventsType = 'WpmfGoogle_Service_Reports_ActivityEvents';
  protected $eventsDataType = 'array';
  protected $idType = 'WpmfGoogle_Service_Reports_ActivityId';
  ...
  public function setActor(WpmfGoogle_Service_Reports_ActivityActor $actor)
  {
    $this->actor = $actor;
  }
  ...
  public function setId(WpmfGoogle_Service_Reports_ActivityId $id)
  {
    $this->id = $id;
  }
...
class WpmfGoogle_Service_Reports_ActivityActor extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $callerType;
...
class WpmfGoogle_Service_Reports_ActivityEvents extends WpmfGoogle_Collection
{
  protected $collection_key = 'parameters';
  protected $internal_gapi_mappings = array(
  );
  public $name;
  protected $parametersType = 'WpmfGoogle_Service_Reports_ActivityEventsParameters';
...
class WpmfGoogle_Service_Reports_ActivityEventsParameters extends WpmfGoogle_Collection
{
...
class WpmfGoogle_Service_Reports_ActivityId extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class WpmfGoogle_Service_Reports_Channel extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $address;
...
class WpmfGoogle_Service_Reports_ChannelParams extends WpmfGoogle_Model
{
}

class WpmfGoogle_Service_Reports_UsageReport extends WpmfGoogle_Collection
{
  protected $collection_key = 'parameters';
  protected $internal_gapi_mappings = array(
  );
  public $date;
  protected $entityType = 'WpmfGoogle_Service_Reports_UsageReportEntity';
  protected $entityDataType = '';
  public $etag;
  public $kind;
  protected $parametersType = 'WpmfGoogle_Service_Reports_UsageReportParameters';
  protected $parametersDataType = 'array';
  ...
  public function setEntity(WpmfGoogle_Service_Reports_UsageReportEntity $entity)
  {
    $this->entity = $entity;
  }
...
class WpmfGoogle_Service_Reports_UsageReportEntity extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $customerId;
...
class WpmfGoogle_Service_Reports_UsageReportParameters extends WpmfGoogle_Collection
{
...
class WpmfGoogle_Service_Reports_UsageReportParametersMsgValue extends WpmfGoogle_Model
{
}

class WpmfGoogle_Service_Reports_UsageReports extends WpmfGoogle_Collection
{
  ...
  public $kind;
  public $nextPageToken;
  protected $usageReportsType = 'WpmfGoogle_Service_Reports_UsageReport';
  protected $usageReportsDataType = 'array';
  protected $warningsType = 'WpmfGoogle_Service_Reports_UsageReportsWarnings';
...
class WpmfGoogle_Service_Reports_UsageReportsWarnings extends WpmfGoogle_Collection
{
  protected $collection_key = 'data';
  protected $internal_gapi_mappings = array(
  );
  public $code;
  protected $dataType = 'WpmfGoogle_Service_Reports_UsageReportsWarningsData';
...
class WpmfGoogle_Service_Reports_UsageReportsWarningsData extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $key;
