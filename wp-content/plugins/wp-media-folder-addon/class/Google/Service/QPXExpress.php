 ...
 * @author Google, Inc.
 */
class WpmfGoogle_Service_QPXExpress extends WpmfGoogle_Service
{
  ...
  public function __construct(WpmfGoogle_Client $client)
  {
    ...
    $this->trips = new WpmfGoogle_Service_QPXExpress_Trips_Resource(
        $this,
        $this->serviceName,
        'trips',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $qpxExpressService = new WpmfGoogle_Service_QPXExpress(...);
 *   $trips = $qpxExpressService->trips;
 *  </code>
 */
class WpmfGoogle_Service_QPXExpress_Trips_Resource extends WpmfGoogle_Service_Resource
{

  /**
   * Returns a list of flights. (trips.search)
   *
   * @param WpmfGoogle_TripsSearchRequest $postBody
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_QPXExpress_TripsSearchResponse
   */
  public function search(WpmfGoogle_Service_QPXExpress_TripsSearchRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('search', array($params), "WpmfGoogle_Service_QPXExpress_TripsSearchResponse");
  }
}
...
class WpmfGoogle_Service_QPXExpress_AircraftData extends WpmfGoogle_Model
{
...
class WpmfGoogle_Service_QPXExpress_AirportData extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $city;
...
class WpmfGoogle_Service_QPXExpress_BagDescriptor extends WpmfGoogle_Collection
{
...
class WpmfGoogle_Service_QPXExpress_CarrierData extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $code;
...
class WpmfGoogle_Service_QPXExpress_CityData extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $code;
...
class WpmfGoogle_Service_QPXExpress_Data extends WpmfGoogle_Collection
{
  protected $collection_key = 'tax';
  protected $internal_gapi_mappings = array(
  );
  protected $aircraftType = 'WpmfGoogle_Service_QPXExpress_AircraftData';
  protected $aircraftDataType = 'array';
  protected $airportType = 'WpmfGoogle_Service_QPXExpress_AirportData';
  protected $airportDataType = 'array';
  protected $carrierType = 'WpmfGoogle_Service_QPXExpress_CarrierData';
  protected $carrierDataType = 'array';
  protected $cityType = 'WpmfGoogle_Service_QPXExpress_CityData';
  protected $cityDataType = 'array';
  public $kind;
  protected $taxType = 'WpmfGoogle_Service_QPXExpress_TaxData';
...
class WpmfGoogle_Service_QPXExpress_FareInfo extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $basisCode;
...
class WpmfGoogle_Service_QPXExpress_FlightInfo extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $carrier;
...
class WpmfGoogle_Service_QPXExpress_FreeBaggageAllowance extends WpmfGoogle_Collection
{
  protected $collection_key = 'bagDescriptor';
  protected $internal_gapi_mappings = array(
  );
  protected $bagDescriptorType = 'WpmfGoogle_Service_QPXExpress_BagDescriptor';
...
class WpmfGoogle_Service_QPXExpress_LegInfo extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $aircraft;
...
class WpmfGoogle_Service_QPXExpress_PassengerCounts extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $adultCount;
...
class WpmfGoogle_Service_QPXExpress_PricingInfo extends WpmfGoogle_Collection
{
  protected $collection_key = 'tax';
  protected $internal_gapi_mappings = array(
  );
  public $baseFareTotal;
  protected $fareType = 'WpmfGoogle_Service_QPXExpress_FareInfo';
  protected $fareDataType = 'array';
  public $fareCalculation;
  public $kind;
  public $latestTicketingTime;
  protected $passengersType = 'WpmfGoogle_Service_QPXExpress_PassengerCounts';
  ...
  public $saleTaxTotal;
  public $saleTotal;
  protected $segmentPricingType = 'WpmfGoogle_Service_QPXExpress_SegmentPricing';
  protected $segmentPricingDataType = 'array';
  protected $taxType = 'WpmfGoogle_Service_QPXExpress_TaxInfo';
  protected $taxDataType = 'array';
  ...
  public function setPassengers(WpmfGoogle_Service_QPXExpress_PassengerCounts $passengers)
  {
...
class WpmfGoogle_Service_QPXExpress_SegmentInfo extends WpmfGoogle_Collection
{
  ...
  public $connectionDuration;
  public $duration;
  protected $flightType = 'WpmfGoogle_Service_QPXExpress_FlightInfo';
  protected $flightDataType = '';
  public $id;
  public $kind;
  protected $legType = 'WpmfGoogle_Service_QPXExpress_LegInfo';
  ...
  public function setFlight(WpmfGoogle_Service_QPXExpress_FlightInfo $flight)
  {
    $this->flight = $flight;
  }
...
class WpmfGoogle_Service_QPXExpress_SegmentPricing extends WpmfGoogle_Collection
{
  protected $collection_key = 'freeBaggageOption';
  protected $internal_gapi_mappings = array(
  );
  public $fareId;
  protected $freeBaggageOptionType = 'WpmfGoogle_Service_QPXExpress_FreeBaggageAllowance';
...
class WpmfGoogle_Service_QPXExpress_SliceInfo extends WpmfGoogle_Collection
{
  ...
  public $duration;
  public $kind;
  protected $segmentType = 'WpmfGoogle_Service_QPXExpress_SegmentInfo';
...
class WpmfGoogle_Service_QPXExpress_SliceInput extends WpmfGoogle_Collection
{
  ...
  protected $permittedDepartureTimeType = 'WpmfGoogle_Service_QPXExpress_TimeOfDayRange';
  ...
  public function setPermittedDepartureTime(WpmfGoogle_Service_QPXExpress_TimeOfDayRange $permittedDepartureTime)
  {
...
class WpmfGoogle_Service_QPXExpress_TaxData extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class WpmfGoogle_Service_QPXExpress_TaxInfo extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $chargeType;
...
class WpmfGoogle_Service_QPXExpress_TimeOfDayRange extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $earliestTime;
...
class WpmfGoogle_Service_QPXExpress_TripOption extends WpmfGoogle_Collection
{
  ...
  public $id;
  public $kind;
  protected $pricingType = 'WpmfGoogle_Service_QPXExpress_PricingInfo';
  protected $pricingDataType = 'array';
  public $saleTotal;
  protected $sliceType = 'WpmfGoogle_Service_QPXExpress_SliceInfo';
...
class WpmfGoogle_Service_QPXExpress_TripOptionsRequest extends WpmfGoogle_Collection
{
  protected $collection_key = 'slice';
  protected $internal_gapi_mappings = array(
  );
  ...
  public $refundable;
  public $saleCountry;
  protected $sliceType = 'WpmfGoogle_Service_QPXExpress_SliceInput';
  protected $sliceDataType = 'array';
  public $solutions;
...
class WpmfGoogle_Service_QPXExpress_TripOptionsResponse extends WpmfGoogle_Collection
{
  protected $collection_key = 'tripOption';
  protected $internal_gapi_mappings = array(
  );
  protected $dataType = 'WpmfGoogle_Service_QPXExpress_Data';
  protected $dataDataType = '';
  public $kind;
  public $requestId;
  protected $tripOptionType = 'WpmfGoogle_Service_QPXExpress_TripOption';
  protected $tripOptionDataType = 'array';


  public function setData(WpmfGoogle_Service_QPXExpress_Data $data)
  {
    $this->data = $data;
  }
...
class WpmfGoogle_Service_QPXExpress_TripsSearchRequest extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $requestType = 'WpmfGoogle_Service_QPXExpress_TripOptionsRequest';
  protected $requestDataType = '';


  public function setRequest(WpmfGoogle_Service_QPXExpress_TripOptionsRequest $request)
  {
...
class WpmfGoogle_Service_QPXExpress_TripsSearchResponse extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
  protected $tripsType = 'WpmfGoogle_Service_QPXExpress_TripOptionsResponse';
  ...
  public function setTrips(WpmfGoogle_Service_QPXExpress_TripOptionsResponse $trips)
  {
    $this->trips = $trips;
  }
