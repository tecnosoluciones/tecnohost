 ...
 * @author Google, Inc.
 */
class WpmfGoogle_Service_Licensing extends WpmfGoogle_Service
{
  ...
  public function __construct(WpmfGoogle_Client $client)
  {
    ...
    $this->licenseAssignments = new WpmfGoogle_Service_Licensing_LicenseAssignments_Resource(
        $this,
        $this->serviceName,
        'licenseAssignments',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $licensingService = new WpmfGoogle_Service_Licensing(...);
 *   $licenseAssignments = $licensingService->licenseAssignments;
 *  </code>
 */
class WpmfGoogle_Service_Licensing_LicenseAssignments_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @param string $userId email id or unique Id of the user
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Licensing_LicenseAssignment
   */
  public function get($productId, $skuId, $userId, $optParams = array())
  {
    $params = array('productId' => $productId, 'skuId' => $skuId, 'userId' => $userId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WpmfGoogle_Service_Licensing_LicenseAssignment");
  }
   ...
   * @param string $productId Name for product
   * @param string $skuId Name for sku
   * @param WpmfGoogle_LicenseAssignmentInsert $postBody
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Licensing_LicenseAssignment
   */
  public function insert($productId, $skuId, WpmfGoogle_Service_Licensing_LicenseAssignmentInsert $postBody, $optParams = array())
  {
    $params = array('productId' => $productId, 'skuId' => $skuId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "WpmfGoogle_Service_Licensing_LicenseAssignment");
  }
   ...
   * @return WpmfGoogle_Service_Licensing_LicenseAssignmentList
   */
  public function listForProduct($productId, $customerId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('listForProduct', array($params), "WpmfGoogle_Service_Licensing_LicenseAssignmentList");
  }
  ...
  public function listForProductAndSku($productId, $skuId, $customerId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('listForProductAndSku', array($params), "WpmfGoogle_Service_Licensing_LicenseAssignmentList");
  }
   ...
   * @param string $userId email id or unique Id of the user
   * @param WpmfGoogle_LicenseAssignment $postBody
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Licensing_LicenseAssignment
   */
  public function patch($productId, $skuId, $userId, WpmfGoogle_Service_Licensing_LicenseAssignment $postBody, $optParams = array())
  {
    $params = array('productId' => $productId, 'skuId' => $skuId, 'userId' => $userId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "WpmfGoogle_Service_Licensing_LicenseAssignment");
  }
   ...
   * @return WpmfGoogle_Service_Licensing_LicenseAssignment
   */
  public function update($productId, $skuId, $userId, WpmfGoogle_Service_Licensing_LicenseAssignment $postBody, $optParams = array())
  {
    $params = array('productId' => $productId, 'skuId' => $skuId, 'userId' => $userId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "WpmfGoogle_Service_Licensing_LicenseAssignment");
  }
}
...
class WpmfGoogle_Service_Licensing_LicenseAssignment extends WpmfGoogle_Model
{
...
class WpmfGoogle_Service_Licensing_LicenseAssignmentInsert extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $userId;
...
class WpmfGoogle_Service_Licensing_LicenseAssignmentList extends WpmfGoogle_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'WpmfGoogle_Service_Licensing_LicenseAssignment';
