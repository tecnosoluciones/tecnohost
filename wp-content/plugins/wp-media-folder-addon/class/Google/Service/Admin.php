 ...
 * @author Google, Inc.
 */
class WpmfGoogle_Service_Admin extends WpmfGoogle_Service
{
  ...
  public function __construct(WpmfGoogle_Client $client)
  {
    ...
    $this->mail = new WpmfGoogle_Service_Admin_Mail_Resource(
        $this,
        $this->serviceName,
        'mail',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $adminService = new WpmfGoogle_Service_Admin(...);
 *   $mail = $adminService->mail;
 *  </code>
 */
class WpmfGoogle_Service_Admin_Mail_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @param WpmfGoogle_MailItem $postBody
   * @param array $optParams Optional parameters.
   */
  public function insert($userKey, WpmfGoogle_Service_Admin_MailItem $postBody, $optParams = array())
  {
...
class WpmfGoogle_Service_Admin_MailItem extends WpmfGoogle_Collection
{
