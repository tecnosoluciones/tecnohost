 ...
 * @author Google, Inc.
 */
class WpmfGoogle_Service_Webmasters extends WpmfGoogle_Service
{
  ...
  public function __construct(WpmfGoogle_Client $client)
  {
    ...
    $this->sitemaps = new WpmfGoogle_Service_Webmasters_Sitemaps_Resource(
        $this,
        $this->serviceName,
        'sitemaps',
        array(
    ...
    $this->sites = new WpmfGoogle_Service_Webmasters_Sites_Resource(
        $this,
        $this->serviceName,
        'sites',
        array(
    ...
    $this->urlcrawlerrorscounts = new WpmfGoogle_Service_Webmasters_Urlcrawlerrorscounts_Resource(
        $this,
        $this->serviceName,
    ...
    $this->urlcrawlerrorssamples = new WpmfGoogle_Service_Webmasters_Urlcrawlerrorssamples_Resource(
        $this,
        $this->serviceName,
 ...
 * Typical usage is:
 *  <code>
 *   $webmastersService = new WpmfGoogle_Service_Webmasters(...);
 *   $sitemaps = $webmastersService->sitemaps;
 *  </code>
 */
class WpmfGoogle_Service_Webmasters_Sitemaps_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * http://www.example.com/sitemap.xml).
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Webmasters_WmxSitemap
   */
  public function get($siteUrl, $feedpath, $optParams = array())
  {
    $params = array('siteUrl' => $siteUrl, 'feedpath' => $feedpath);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WpmfGoogle_Service_Webmasters_WmxSitemap");
  }
   ...
   * @return WpmfGoogle_Service_Webmasters_SitemapsListResponse
   */
  public function listSitemaps($siteUrl, $optParams = array())
  {
    $params = array('siteUrl' => $siteUrl);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WpmfGoogle_Service_Webmasters_SitemapsListResponse");
  }
 ...
 *  </code>
 */
class WpmfGoogle_Service_Webmasters_Sites_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * 'http://www.example.com/'
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Webmasters_WmxSite
   */
  public function get($siteUrl, $optParams = array())
  {
    $params = array('siteUrl' => $siteUrl);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WpmfGoogle_Service_Webmasters_WmxSite");
  }
   ...
   *
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Webmasters_SitesListResponse
   */
  public function listSites($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WpmfGoogle_Service_Webmasters_SitesListResponse");
  }
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_Webmasters_Urlcrawlerrorscounts_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * counts.
   * @return WpmfGoogle_Service_Webmasters_UrlCrawlErrorsCountsQueryResponse
   */
  public function query($siteUrl, $optParams = array())
  {
    $params = array('siteUrl' => $siteUrl);
    $params = array_merge($params, $optParams);
    return $this->call('query', array($params), "WpmfGoogle_Service_Webmasters_UrlCrawlErrorsCountsQueryResponse");
  }
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_Webmasters_Urlcrawlerrorssamples_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * for example 'web'
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Webmasters_UrlCrawlErrorsSample
   */
  public function get($siteUrl, $url, $category, $platform, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WpmfGoogle_Service_Webmasters_UrlCrawlErrorsSample");
  }
   ...
   * for example 'web'
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Webmasters_UrlCrawlErrorsSamplesListResponse
   */
  public function listUrlcrawlerrorssamples($siteUrl, $category, $platform, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WpmfGoogle_Service_Webmasters_UrlCrawlErrorsSamplesListResponse");
  }
...
class WpmfGoogle_Service_Webmasters_SitemapsListResponse extends WpmfGoogle_Collection
{
  protected $collection_key = 'sitemap';
  protected $internal_gapi_mappings = array(
  );
  protected $sitemapType = 'WpmfGoogle_Service_Webmasters_WmxSitemap';
...
class WpmfGoogle_Service_Webmasters_SitesListResponse extends WpmfGoogle_Collection
{
  protected $collection_key = 'siteEntry';
  protected $internal_gapi_mappings = array(
  );
  protected $siteEntryType = 'WpmfGoogle_Service_Webmasters_WmxSite';
...
class WpmfGoogle_Service_Webmasters_UrlCrawlErrorCount extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $count;
...
class WpmfGoogle_Service_Webmasters_UrlCrawlErrorCountsPerType extends WpmfGoogle_Collection
{
  protected $collection_key = 'entries';
  protected $internal_gapi_mappings = array(
  );
  public $category;
  protected $entriesType = 'WpmfGoogle_Service_Webmasters_UrlCrawlErrorCount';
...
class WpmfGoogle_Service_Webmasters_UrlCrawlErrorsCountsQueryResponse extends WpmfGoogle_Collection
{
  protected $collection_key = 'countPerTypes';
  protected $internal_gapi_mappings = array(
  );
  protected $countPerTypesType = 'WpmfGoogle_Service_Webmasters_UrlCrawlErrorCountsPerType';
...
class WpmfGoogle_Service_Webmasters_UrlCrawlErrorsSample extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  ...
  public $pageUrl;
  public $responseCode;
  protected $urlDetailsType = 'WpmfGoogle_Service_Webmasters_UrlSampleDetails';
  ...
  public function setUrlDetails(WpmfGoogle_Service_Webmasters_UrlSampleDetails $urlDetails)
  {
...
class WpmfGoogle_Service_Webmasters_UrlCrawlErrorsSamplesListResponse extends WpmfGoogle_Collection
{
  protected $collection_key = 'urlCrawlErrorSample';
  protected $internal_gapi_mappings = array(
  );
  protected $urlCrawlErrorSampleType = 'WpmfGoogle_Service_Webmasters_UrlCrawlErrorsSample';
...
class WpmfGoogle_Service_Webmasters_UrlSampleDetails extends WpmfGoogle_Collection
{
...
class WpmfGoogle_Service_Webmasters_WmxSite extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class WpmfGoogle_Service_Webmasters_WmxSitemap extends WpmfGoogle_Collection
{
  protected $collection_key = 'contents';
  protected $internal_gapi_mappings = array(
  );
  protected $contentsType = 'WpmfGoogle_Service_Webmasters_WmxSitemapContent';
...
class WpmfGoogle_Service_Webmasters_WmxSitemapContent extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $indexed;
