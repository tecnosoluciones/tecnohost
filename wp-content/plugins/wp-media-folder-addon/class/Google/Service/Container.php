 ...
 * @author Google, Inc.
 */
class WpmfGoogle_Service_Container extends WpmfGoogle_Service
{
  ...
  public function __construct(WpmfGoogle_Client $client)
  {
    ...
    $this->projects_clusters = new WpmfGoogle_Service_Container_ProjectsClusters_Resource(
        $this,
        $this->serviceName,
        'clusters',
        array(
    ...
    $this->projects_operations = new WpmfGoogle_Service_Container_ProjectsOperations_Resource(
        $this,
        $this->serviceName,
        'operations',
        array(
    ...
    $this->projects_zones_clusters = new WpmfGoogle_Service_Container_ProjectsZonesClusters_Resource(
        $this,
        $this->serviceName,
        'clusters',
        array(
    ...
    $this->projects_zones_operations = new WpmfGoogle_Service_Container_ProjectsZonesOperations_Resource(
        $this,
        $this->serviceName,
        'operations',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $containerService = new WpmfGoogle_Service_Container(...);
 *   $projects = $containerService->projects;
 *  </code>
 */
class WpmfGoogle_Service_Container_Projects_Resource extends WpmfGoogle_Service_Resource
{
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_Container_ProjectsClusters_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @return WpmfGoogle_Service_Container_ListAggregatedClustersResponse
   */
  public function listProjectsClusters($projectId, $optParams = array())
  {
    $params = array('projectId' => $projectId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WpmfGoogle_Service_Container_ListAggregatedClustersResponse");
  }
}
/**
 ...
 *  </code>
 */
class WpmfGoogle_Service_Container_ProjectsOperations_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * number.
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Container_ListAggregatedOperationsResponse
   */
  public function listProjectsOperations($projectId, $optParams = array())
  {
    $params = array('projectId' => $projectId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WpmfGoogle_Service_Container_ListAggregatedOperationsResponse");
  }
}
/**
 ...
 *  </code>
 */
class WpmfGoogle_Service_Container_ProjectsZones_Resource extends WpmfGoogle_Service_Resource
{
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_Container_ProjectsZonesClusters_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * cluster resides.
   * @param WpmfGoogle_CreateClusterRequest $postBody
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Container_Operation
   */
  public function create($projectId, $zoneId, WpmfGoogle_Service_Container_CreateClusterRequest $postBody, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'zoneId' => $zoneId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "WpmfGoogle_Service_Container_Operation");
  }
  ...
  public function delete($projectId, $zoneId, $clusterId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "WpmfGoogle_Service_Container_Operation");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Container_Cluster
   */
  public function get($projectId, $zoneId, $clusterId, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'zoneId' => $zoneId, 'clusterId' => $clusterId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WpmfGoogle_Service_Container_Cluster");
  }
   ...
   * cluster resides.
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Container_ListClustersResponse
   */
  public function listProjectsZonesClusters($projectId, $zoneId, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'zoneId' => $zoneId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WpmfGoogle_Service_Container_ListClustersResponse");
  }
}
/**
 * The "operations" collection of methods.
 ...
 *  </code>
 */
class WpmfGoogle_Service_Container_ProjectsZonesOperations_Resource extends WpmfGoogle_Service_Resource
{
  ...
  public function get($projectId, $zoneId, $operationId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WpmfGoogle_Service_Container_Operation");
  }
   ...
   * operations for.
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Container_ListOperationsResponse
   */
  public function listProjectsZonesOperations($projectId, $zoneId, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'zoneId' => $zoneId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WpmfGoogle_Service_Container_ListOperationsResponse");
  }
}
...
class WpmfGoogle_Service_Container_Cluster extends WpmfGoogle_Model
{
  ...
  public $description;
  public $endpoint;
  protected $masterAuthType = 'WpmfGoogle_Service_Container_MasterAuth';
  protected $masterAuthDataType = '';
  public $name;
  public $network;
  protected $nodeConfigType = 'WpmfGoogle_Service_Container_NodeConfig';
  ...
  public function setMasterAuth(WpmfGoogle_Service_Container_MasterAuth $masterAuth)
  {
  ...
  public function setNodeConfig(WpmfGoogle_Service_Container_NodeConfig $nodeConfig)
  {
...
class WpmfGoogle_Service_Container_CreateClusterRequest extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $clusterType = 'WpmfGoogle_Service_Container_Cluster';
  protected $clusterDataType = '';


  public function setCluster(WpmfGoogle_Service_Container_Cluster $cluster)
  {
...
class WpmfGoogle_Service_Container_ListAggregatedClustersResponse extends WpmfGoogle_Collection
{
  protected $collection_key = 'clusters';
  protected $internal_gapi_mappings = array(
  );
  protected $clustersType = 'WpmfGoogle_Service_Container_Cluster';
...
class WpmfGoogle_Service_Container_ListAggregatedOperationsResponse extends WpmfGoogle_Collection
{
  protected $collection_key = 'operations';
  protected $internal_gapi_mappings = array(
  );
  protected $operationsType = 'WpmfGoogle_Service_Container_Operation';
...
class WpmfGoogle_Service_Container_ListClustersResponse extends WpmfGoogle_Collection
{
  protected $collection_key = 'clusters';
  protected $internal_gapi_mappings = array(
  );
...
class WpmfGoogle_Service_Container_ListOperationsResponse extends WpmfGoogle_Collection
{
  protected $collection_key = 'operations';
  protected $internal_gapi_mappings = array(
  );
...
class WpmfGoogle_Service_Container_MasterAuth extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $password;
...
class WpmfGoogle_Service_Container_NodeConfig extends WpmfGoogle_Collection
{
  protected $collection_key = 'serviceAccounts';
  protected $internal_gapi_mappings = array(
  );
  public $machineType;
  protected $serviceAccountsType = 'WpmfGoogle_Service_Container_ServiceAccount';
...
class WpmfGoogle_Service_Container_Operation extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $errorMessage;
...
class WpmfGoogle_Service_Container_ServiceAccount extends WpmfGoogle_Collection
{
