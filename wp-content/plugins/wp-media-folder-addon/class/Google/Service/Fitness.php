 ...
 * @author Google, Inc.
 */
class WpmfGoogle_Service_Fitness extends WpmfGoogle_Service
{
  ...
  public function __construct(WpmfGoogle_Client $client)
  {
    ...
    $this->users_dataSources = new WpmfGoogle_Service_Fitness_UsersDataSources_Resource(
        $this,
        $this->serviceName,
        'dataSources',
        array(
    ...
    $this->users_dataSources_datasets = new WpmfGoogle_Service_Fitness_UsersDataSourcesDatasets_Resource(
        $this,
        $this->serviceName,
        'datasets',
        array(
    ...
    $this->users_sessions = new WpmfGoogle_Service_Fitness_UsersSessions_Resource(
        $this,
        $this->serviceName,
        'sessions',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $fitnessService = new WpmfGoogle_Service_Fitness(...);
 *   $users = $fitnessService->users;
 *  </code>
 */
class WpmfGoogle_Service_Fitness_Users_Resource extends WpmfGoogle_Service_Resource
{
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_Fitness_UsersDataSources_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @param WpmfGoogle_DataSource $postBody
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Fitness_DataSource
   */
  public function create($userId, WpmfGoogle_Service_Fitness_DataSource $postBody, $optParams = array())
  {
    $params = array('userId' => $userId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "WpmfGoogle_Service_Fitness_DataSource");
  }
  ...
  public function get($userId, $dataSourceId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WpmfGoogle_Service_Fitness_DataSource");
  }
   ...
   * @return WpmfGoogle_Service_Fitness_ListDataSourcesResponse
   */
  public function listUsersDataSources($userId, $optParams = array())
  {
    $params = array('userId' => $userId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WpmfGoogle_Service_Fitness_ListDataSourcesResponse");
  }
   ...
   * @return WpmfGoogle_Service_Fitness_DataSource
   */
  public function patch($userId, $dataSourceId, WpmfGoogle_Service_Fitness_DataSource $postBody, $optParams = array())
  {
    $params = array('userId' => $userId, 'dataSourceId' => $dataSourceId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "WpmfGoogle_Service_Fitness_DataSource");
  }
   ...
   * @return WpmfGoogle_Service_Fitness_DataSource
   */
  public function update($userId, $dataSourceId, WpmfGoogle_Service_Fitness_DataSource $postBody, $optParams = array())
  {
    $params = array('userId' => $userId, 'dataSourceId' => $dataSourceId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "WpmfGoogle_Service_Fitness_DataSource");
  }
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_Fitness_UsersDataSourcesDatasets_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @return WpmfGoogle_Service_Fitness_Dataset
   */
  public function get($userId, $dataSourceId, $datasetId, $optParams = array())
  {
    $params = array('userId' => $userId, 'dataSourceId' => $dataSourceId, 'datasetId' => $datasetId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WpmfGoogle_Service_Fitness_Dataset");
  }
   ...
   * @return WpmfGoogle_Service_Fitness_Dataset
   */
  public function patch($userId, $dataSourceId, $datasetId, WpmfGoogle_Service_Fitness_Dataset $postBody, $optParams = array())
  {
    $params = array('userId' => $userId, 'dataSourceId' => $dataSourceId, 'datasetId' => $datasetId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "WpmfGoogle_Service_Fitness_Dataset");
  }
}
/**
 ...
 *  </code>
 */
class WpmfGoogle_Service_Fitness_UsersSessions_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @return WpmfGoogle_Service_Fitness_ListSessionsResponse
   */
  public function listUsersSessions($userId, $optParams = array())
  {
    $params = array('userId' => $userId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WpmfGoogle_Service_Fitness_ListSessionsResponse");
  }
   ...
   * @param WpmfGoogle_Session $postBody
   * @param array $optParams Optional parameters.
   *
   * @opt_param string currentTimeMillis The client's current time in milliseconds
   * since epoch.
   * @return WpmfGoogle_Service_Fitness_Session
   */
  public function update($userId, $sessionId, WpmfGoogle_Service_Fitness_Session $postBody, $optParams = array())
  {
    $params = array('userId' => $userId, 'sessionId' => $sessionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "WpmfGoogle_Service_Fitness_Session");
  }
}
...
class WpmfGoogle_Service_Fitness_Application extends WpmfGoogle_Model
{
...
class WpmfGoogle_Service_Fitness_DataPoint extends WpmfGoogle_Collection
{
  ...
  protected $valueType = 'WpmfGoogle_Service_Fitness_Value';
...
class WpmfGoogle_Service_Fitness_DataSource extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $applicationType = 'WpmfGoogle_Service_Fitness_Application';
  protected $applicationDataType = '';
  public $dataStreamId;
  public $dataStreamName;
  protected $dataTypeType = 'WpmfGoogle_Service_Fitness_DataType';
  protected $dataTypeDataType = '';
  protected $deviceType = 'WpmfGoogle_Service_Fitness_Device';
  protected $deviceDataType = '';
  public $name;
  public $type;


  public function setApplication(WpmfGoogle_Service_Fitness_Application $application)
  {
  ...
  public function setDataType(WpmfGoogle_Service_Fitness_DataType $dataType)
  {
  ...
  public function setDevice(WpmfGoogle_Service_Fitness_Device $device)
  {
    $this->device = $device;
  }
...
class WpmfGoogle_Service_Fitness_DataType extends WpmfGoogle_Collection
{
  protected $collection_key = 'field';
  protected $internal_gapi_mappings = array(
  );
  protected $fieldType = 'WpmfGoogle_Service_Fitness_DataTypeField';
...
class WpmfGoogle_Service_Fitness_DataTypeField extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $format;
...
class WpmfGoogle_Service_Fitness_Dataset extends WpmfGoogle_Collection
{
  ...
  protected $pointType = 'WpmfGoogle_Service_Fitness_DataPoint';
...
class WpmfGoogle_Service_Fitness_Device extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $manufacturer;
...
class WpmfGoogle_Service_Fitness_ListDataSourcesResponse extends WpmfGoogle_Collection
{
  protected $collection_key = 'dataSource';
  protected $internal_gapi_mappings = array(
  );
  protected $dataSourceType = 'WpmfGoogle_Service_Fitness_DataSource';
...
class WpmfGoogle_Service_Fitness_ListSessionsResponse extends WpmfGoogle_Collection
{
  protected $collection_key = 'session';
  protected $internal_gapi_mappings = array(
  );
  protected $deletedSessionType = 'WpmfGoogle_Service_Fitness_Session';
  protected $deletedSessionDataType = 'array';
  public $nextPageToken;
  protected $sessionType = 'WpmfGoogle_Service_Fitness_Session';
...
class WpmfGoogle_Service_Fitness_Session extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $activityType;
...
class WpmfGoogle_Service_Fitness_Value extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $fpVal;
