 ...
 * @author Google, Inc.
 */
class WpmfGoogle_Service_Replicapoolupdater extends WpmfGoogle_Service
{
  ...
  public function __construct(WpmfGoogle_Client $client)
  {
    ...
    $this->rollingUpdates = new WpmfGoogle_Service_Replicapoolupdater_RollingUpdates_Resource(
        $this,
        $this->serviceName,
        'rollingUpdates',
        array(
    ...
    $this->zoneOperations = new WpmfGoogle_Service_Replicapoolupdater_ZoneOperations_Resource(
        $this,
        $this->serviceName,
        'zoneOperations',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $replicapoolupdaterService = new WpmfGoogle_Service_Replicapoolupdater(...);
 *   $rollingUpdates = $replicapoolupdaterService->rollingUpdates;
 *  </code>
 */
class WpmfGoogle_Service_Replicapoolupdater_RollingUpdates_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @return WpmfGoogle_Service_Replicapoolupdater_Operation
   */
  public function cancel($project, $zone, $rollingUpdate, $optParams = array())
  {
    ...
    return $this->call('cancel', array($params), "WpmfGoogle_Service_Replicapoolupdater_Operation");
  }
   ...
   * @param string $rollingUpdate The name of the update.
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Replicapoolupdater_RollingUpdate
   */
  public function get($project, $zone, $rollingUpdate, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone, 'rollingUpdate' => $rollingUpdate);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WpmfGoogle_Service_Replicapoolupdater_RollingUpdate");
  }
   ...
   * @param string $zone The name of the zone in which the update's target
   * resides.
   * @param WpmfGoogle_RollingUpdate $postBody
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Replicapoolupdater_Operation
   */
  public function insert($project, $zone, WpmfGoogle_Service_Replicapoolupdater_RollingUpdate $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "WpmfGoogle_Service_Replicapoolupdater_Operation");
  }
   ...
   * used for filtering.
   * @return WpmfGoogle_Service_Replicapoolupdater_RollingUpdateList
   */
  public function listRollingUpdates($project, $zone, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WpmfGoogle_Service_Replicapoolupdater_RollingUpdateList");
  }
   ...
   * @opt_param string pageToken Optional. Tag returned by a previous list request
   * truncated by maxResults. Used to continue a previous list request.
   * @return WpmfGoogle_Service_Replicapoolupdater_InstanceUpdateList
   */
  public function listInstanceUpdates($project, $zone, $rollingUpdate, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone, 'rollingUpdate' => $rollingUpdate);
    $params = array_merge($params, $optParams);
    return $this->call('listInstanceUpdates', array($params), "WpmfGoogle_Service_Replicapoolupdater_InstanceUpdateList");
  }
  ...
  public function pause($project, $zone, $rollingUpdate, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone, 'rollingUpdate' => $rollingUpdate);
    $params = array_merge($params, $optParams);
    return $this->call('pause', array($params), "WpmfGoogle_Service_Replicapoolupdater_Operation");
  }
  ...
  public function resume($project, $zone, $rollingUpdate, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone, 'rollingUpdate' => $rollingUpdate);
    $params = array_merge($params, $optParams);
    return $this->call('resume', array($params), "WpmfGoogle_Service_Replicapoolupdater_Operation");
  }
  ...
  public function rollback($project, $zone, $rollingUpdate, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone, 'rollingUpdate' => $rollingUpdate);
    $params = array_merge($params, $optParams);
    return $this->call('rollback', array($params), "WpmfGoogle_Service_Replicapoolupdater_Operation");
  }
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_Replicapoolupdater_ZoneOperations_Resource extends WpmfGoogle_Service_Resource
{
  ...
  public function get($project, $zone, $operation, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WpmfGoogle_Service_Replicapoolupdater_Operation");
  }
}
...
class WpmfGoogle_Service_Replicapoolupdater_InstanceUpdate extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $errorType = 'WpmfGoogle_Service_Replicapoolupdater_InstanceUpdateError';
  protected $errorDataType = '';
  public $instance;
  public $status;


  public function setError(WpmfGoogle_Service_Replicapoolupdater_InstanceUpdateError $error)
  {
    $this->error = $error;
  }
...
class WpmfGoogle_Service_Replicapoolupdater_InstanceUpdateError extends WpmfGoogle_Collection
{
  protected $collection_key = 'errors';
  protected $internal_gapi_mappings = array(
  );
  protected $errorsType = 'WpmfGoogle_Service_Replicapoolupdater_InstanceUpdateErrorErrors';
...
class WpmfGoogle_Service_Replicapoolupdater_InstanceUpdateErrorErrors extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $code;
...
class WpmfGoogle_Service_Replicapoolupdater_InstanceUpdateList extends WpmfGoogle_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'WpmfGoogle_Service_Replicapoolupdater_InstanceUpdate';
...
class WpmfGoogle_Service_Replicapoolupdater_Operation extends WpmfGoogle_Collection
{
  ...
  public $endTime;
  protected $errorType = 'WpmfGoogle_Service_Replicapoolupdater_OperationError';
  protected $errorDataType = '';
  ...
  public $targetLink;
  public $user;
  protected $warningsType = 'WpmfGoogle_Service_Replicapoolupdater_OperationWarnings';
  ...
  public function setError(WpmfGoogle_Service_Replicapoolupdater_OperationError $error)
  {
    $this->error = $error;
  }
  public function getError()
...
class WpmfGoogle_Service_Replicapoolupdater_OperationError extends WpmfGoogle_Collection
{
  protected $collection_key = 'errors';
  protected $internal_gapi_mappings = array(
  );
  protected $errorsType = 'WpmfGoogle_Service_Replicapoolupdater_OperationErrorErrors';
  protected $errorsDataType = 'array';
...
class WpmfGoogle_Service_Replicapoolupdater_OperationErrorErrors extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $code;
...
class WpmfGoogle_Service_Replicapoolupdater_OperationWarnings extends WpmfGoogle_Collection
{
  protected $collection_key = 'data';
  protected $internal_gapi_mappings = array(
  );
  public $code;
  protected $dataType = 'WpmfGoogle_Service_Replicapoolupdater_OperationWarningsData';
...
class WpmfGoogle_Service_Replicapoolupdater_OperationWarningsData extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $key;
...
class WpmfGoogle_Service_Replicapoolupdater_RollingUpdate extends WpmfGoogle_Collection
{
  ...
  public $creationTimestamp;
  public $description;
  protected $errorType = 'WpmfGoogle_Service_Replicapoolupdater_RollingUpdateError';
  protected $errorDataType = '';
  public $id;
  ...
  public $instances;
  public $kind;
  protected $policyType = 'WpmfGoogle_Service_Replicapoolupdater_RollingUpdatePolicy';
  ...
  public function setError(WpmfGoogle_Service_Replicapoolupdater_RollingUpdateError $error)
  {
    $this->error = $error;
  }
  public function getError()
  ...
  public function setPolicy(WpmfGoogle_Service_Replicapoolupdater_RollingUpdatePolicy $policy)
  {
    $this->policy = $policy;
  }
...
class WpmfGoogle_Service_Replicapoolupdater_RollingUpdateError extends WpmfGoogle_Collection
{
  protected $collection_key = 'errors';
  protected $internal_gapi_mappings = array(
  );
  protected $errorsType = 'WpmfGoogle_Service_Replicapoolupdater_RollingUpdateErrorErrors';
  protected $errorsDataType = 'array';
...
class WpmfGoogle_Service_Replicapoolupdater_RollingUpdateErrorErrors extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $code;
...
class WpmfGoogle_Service_Replicapoolupdater_RollingUpdateList extends WpmfGoogle_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'WpmfGoogle_Service_Replicapoolupdater_RollingUpdate';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  public $selfLink;
...
class WpmfGoogle_Service_Replicapoolupdater_RollingUpdatePolicy extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
