 ...
 * @author Google, Inc.
 */
class WpmfGoogle_Service_Appsactivity extends WpmfGoogle_Service
{
  ...
  public function __construct(WpmfGoogle_Client $client)
  {
    ...
    $this->activities = new WpmfGoogle_Service_Appsactivity_Activities_Resource(
        $this,
        $this->serviceName,
        'activities',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $appsactivityService = new WpmfGoogle_Service_Appsactivity(...);
 *   $activities = $appsactivityService->activities;
 *  </code>
 */
class WpmfGoogle_Service_Appsactivity_Activities_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @return WpmfGoogle_Service_Appsactivity_ListActivitiesResponse
   */
  public function listActivities($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WpmfGoogle_Service_Appsactivity_ListActivitiesResponse");
  }
}
...
class WpmfGoogle_Service_Appsactivity_Activity extends WpmfGoogle_Collection
{
  protected $collection_key = 'singleEvents';
  protected $internal_gapi_mappings = array(
  );
  protected $combinedEventType = 'WpmfGoogle_Service_Appsactivity_Event';
  protected $combinedEventDataType = '';
  protected $singleEventsType = 'WpmfGoogle_Service_Appsactivity_Event';
  protected $singleEventsDataType = 'array';


  public function setCombinedEvent(WpmfGoogle_Service_Appsactivity_Event $combinedEvent)
  {
...
class WpmfGoogle_Service_Appsactivity_Event extends WpmfGoogle_Collection
{
  ...
  protected $moveType = 'WpmfGoogle_Service_Appsactivity_Move';
  protected $moveDataType = '';
  protected $permissionChangesType = 'WpmfGoogle_Service_Appsactivity_PermissionChange';
  protected $permissionChangesDataType = 'array';
  public $primaryEventType;
  protected $renameType = 'WpmfGoogle_Service_Appsactivity_Rename';
  protected $renameDataType = '';
  protected $targetType = 'WpmfGoogle_Service_Appsactivity_Target';
  protected $targetDataType = '';
  protected $userType = 'WpmfGoogle_Service_Appsactivity_User';
  ...
  public function setMove(WpmfGoogle_Service_Appsactivity_Move $move)
  {
    $this->move = $move;
  }
  ...
  public function setRename(WpmfGoogle_Service_Appsactivity_Rename $rename)
  {
    $this->rename = $rename;
  }
  ...
  public function setTarget(WpmfGoogle_Service_Appsactivity_Target $target)
  {
    $this->target = $target;
  }
  ...
  public function setUser(WpmfGoogle_Service_Appsactivity_User $user)
  {
    $this->user = $user;
  }
...
class WpmfGoogle_Service_Appsactivity_ListActivitiesResponse extends WpmfGoogle_Collection
{
  protected $collection_key = 'activities';
  protected $internal_gapi_mappings = array(
  );
  protected $activitiesType = 'WpmfGoogle_Service_Appsactivity_Activity';
...
class WpmfGoogle_Service_Appsactivity_Move extends WpmfGoogle_Collection
{
  protected $collection_key = 'removedParents';
  protected $internal_gapi_mappings = array(
  );
  protected $addedParentsType = 'WpmfGoogle_Service_Appsactivity_Parent';
  protected $addedParentsDataType = 'array';
  protected $removedParentsType = 'WpmfGoogle_Service_Appsactivity_Parent';
...
class WpmfGoogle_Service_Appsactivity_Parent extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class WpmfGoogle_Service_Appsactivity_Permission extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $name;
...
class WpmfGoogle_Service_Appsactivity_PermissionChange extends WpmfGoogle_Collection
{
  protected $collection_key = 'removedPermissions';
  protected $internal_gapi_mappings = array(
  );
  protected $addedPermissionsType = 'WpmfGoogle_Service_Appsactivity_Permission';
  protected $addedPermissionsDataType = 'array';
  protected $removedPermissionsType = 'WpmfGoogle_Service_Appsactivity_Permission';
...
class WpmfGoogle_Service_Appsactivity_Photo extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $url;
...
class WpmfGoogle_Service_Appsactivity_Rename extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $newTitle;
...
class WpmfGoogle_Service_Appsactivity_Target extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class WpmfGoogle_Service_Appsactivity_User extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $name;
  protected $photoType = 'WpmfGoogle_Service_Appsactivity_Photo';
  ...
  public function setPhoto(WpmfGoogle_Service_Appsactivity_Photo $photo)
  {
    $this->photo = $photo;
  }
