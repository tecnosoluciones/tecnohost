 ...
 * @author Google, Inc.
 */
class WpmfGoogle_Service_Coordinate extends WpmfGoogle_Service
{
  ...
  public function __construct(WpmfGoogle_Client $client)
  {
    ...
    $this->customFieldDef = new WpmfGoogle_Service_Coordinate_CustomFieldDef_Resource(
        $this,
        $this->serviceName,
        'customFieldDef',
        array(
    ...
    $this->jobs = new WpmfGoogle_Service_Coordinate_Jobs_Resource(
        $this,
        $this->serviceName,
        'jobs',
        array(
    ...
    $this->location = new WpmfGoogle_Service_Coordinate_Location_Resource(
        $this,
        $this->serviceName,
        'location',
        array(
    ...
    $this->schedule = new WpmfGoogle_Service_Coordinate_Schedule_Resource(
        $this,
        $this->serviceName,
        'schedule',
        array(
    ...
    $this->team = new WpmfGoogle_Service_Coordinate_Team_Resource(
        $this,
        $this->serviceName,
        'team',
        array(
    ...
    $this->worker = new WpmfGoogle_Service_Coordinate_Worker_Resource(
        $this,
        $this->serviceName,
        'worker',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $coordinateService = new WpmfGoogle_Service_Coordinate(...);
 *   $customFieldDef = $coordinateService->customFieldDef;
 *  </code>
 */
class WpmfGoogle_Service_Coordinate_CustomFieldDef_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @return WpmfGoogle_Service_Coordinate_CustomFieldDefListResponse
   */
  public function listCustomFieldDef($teamId, $optParams = array())
  {
    $params = array('teamId' => $teamId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WpmfGoogle_Service_Coordinate_CustomFieldDefListResponse");
  }
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_Coordinate_Jobs_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Coordinate_Job
   */
  public function get($teamId, $jobId, $optParams = array())
  {
    $params = array('teamId' => $teamId, 'jobId' => $jobId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WpmfGoogle_Service_Coordinate_Job");
  }
   ...
   * @return WpmfGoogle_Service_Coordinate_Job
   */
  public function insert($teamId, $address, $lat, $lng, $title, WpmfGoogle_Service_Coordinate_Job $postBody, $optParams = array())
  {
    $params = array('teamId' => $teamId, 'address' => $address, 'lat' => $lat, 'lng' => $lng, 'title' => $title, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "WpmfGoogle_Service_Coordinate_Job");
  }
   ...
   * @return WpmfGoogle_Service_Coordinate_JobListResponse
   */
  public function listJobs($teamId, $optParams = array())
  {
    $params = array('teamId' => $teamId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WpmfGoogle_Service_Coordinate_JobListResponse");
  }
   ...
   * @return WpmfGoogle_Service_Coordinate_Job
   */
  public function patch($teamId, $jobId, WpmfGoogle_Service_Coordinate_Job $postBody, $optParams = array())
  {
    $params = array('teamId' => $teamId, 'jobId' => $jobId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "WpmfGoogle_Service_Coordinate_Job");
  }
   ...
   * @return WpmfGoogle_Service_Coordinate_Job
   */
  public function update($teamId, $jobId, WpmfGoogle_Service_Coordinate_Job $postBody, $optParams = array())
  {
    $params = array('teamId' => $teamId, 'jobId' => $jobId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "WpmfGoogle_Service_Coordinate_Job");
  }
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_Coordinate_Location_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @opt_param string pageToken Continuation token
   * @opt_param string maxResults Maximum number of results to return in one page.
   * @return WpmfGoogle_Service_Coordinate_LocationListResponse
   */
  public function listLocation($teamId, $workerEmail, $startTimestampMs, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WpmfGoogle_Service_Coordinate_LocationListResponse");
  }
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_Coordinate_Schedule_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @param string $jobId Job number
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Coordinate_Schedule
   */
  public function get($teamId, $jobId, $optParams = array())
  {
    $params = array('teamId' => $teamId, 'jobId' => $jobId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WpmfGoogle_Service_Coordinate_Schedule");
  }
   ...
   * @param string $teamId Team ID
   * @param string $jobId Job number
   * @param WpmfGoogle_Schedule $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return WpmfGoogle_Service_Coordinate_Schedule
   */
  public function patch($teamId, $jobId, WpmfGoogle_Service_Coordinate_Schedule $postBody, $optParams = array())
  {
    $params = array('teamId' => $teamId, 'jobId' => $jobId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "WpmfGoogle_Service_Coordinate_Schedule");
  }
   ...
   * @return WpmfGoogle_Service_Coordinate_Schedule
   */
  public function update($teamId, $jobId, WpmfGoogle_Service_Coordinate_Schedule $postBody, $optParams = array())
  {
    $params = array('teamId' => $teamId, 'jobId' => $jobId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "WpmfGoogle_Service_Coordinate_Schedule");
  }
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_Coordinate_Team_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * the Dispatcher role.
   * @return WpmfGoogle_Service_Coordinate_TeamListResponse
   */
  public function listTeam($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WpmfGoogle_Service_Coordinate_TeamListResponse");
  }
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_Coordinate_Worker_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @param string $teamId Team ID
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Coordinate_WorkerListResponse
   */
  public function listWorker($teamId, $optParams = array())
  {
    $params = array('teamId' => $teamId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WpmfGoogle_Service_Coordinate_WorkerListResponse");
  }
}
...
class WpmfGoogle_Service_Coordinate_CustomField extends WpmfGoogle_Model
{
...
class WpmfGoogle_Service_Coordinate_CustomFieldDef extends WpmfGoogle_Collection
{
  protected $collection_key = 'enumitems';
  protected $internal_gapi_mappings = array(
  );
  public $enabled;
  protected $enumitemsType = 'WpmfGoogle_Service_Coordinate_EnumItemDef';
...
class WpmfGoogle_Service_Coordinate_CustomFieldDefListResponse extends WpmfGoogle_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'WpmfGoogle_Service_Coordinate_CustomFieldDef';
...
class WpmfGoogle_Service_Coordinate_CustomFields extends WpmfGoogle_Collection
{
  protected $collection_key = 'customField';
  protected $internal_gapi_mappings = array(
  );
  protected $customFieldType = 'WpmfGoogle_Service_Coordinate_CustomField';
...
class WpmfGoogle_Service_Coordinate_EnumItemDef extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $active;
...
class WpmfGoogle_Service_Coordinate_Job extends WpmfGoogle_Collection
{
  protected $collection_key = 'jobChange';
  protected $internal_gapi_mappings = array(
  );
  public $id;
  protected $jobChangeType = 'WpmfGoogle_Service_Coordinate_JobChange';
  protected $jobChangeDataType = 'array';
  public $kind;
  protected $stateType = 'WpmfGoogle_Service_Coordinate_JobState';
  ...
  public function setState(WpmfGoogle_Service_Coordinate_JobState $state)
  {
    $this->state = $state;
  }
...
class WpmfGoogle_Service_Coordinate_JobChange extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
...
class WpmfGoogle_Service_Coordinate_JobListResponse extends WpmfGoogle_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'WpmfGoogle_Service_Coordinate_Job';
  protected $itemsDataType = 'array';
  public $kind;
...
class WpmfGoogle_Service_Coordinate_JobState extends WpmfGoogle_Collection
{
  protected $collection_key = 'note';
  protected $internal_gapi_mappings = array(
  );
  public $assignee;
  protected $customFieldsType = 'WpmfGoogle_Service_Coordinate_CustomFields';
  protected $customFieldsDataType = '';
  public $customerName;
  public $customerPhoneNumber;
  public $kind;
  protected $locationType = 'WpmfGoogle_Service_Coordinate_Location';
  ...
  public function setCustomFields(WpmfGoogle_Service_Coordinate_CustomFields $customFields)
  {
  ...
  public function setLocation(WpmfGoogle_Service_Coordinate_Location $location)
  {
...
class WpmfGoogle_Service_Coordinate_Location extends WpmfGoogle_Collection
{
...
class WpmfGoogle_Service_Coordinate_LocationListResponse extends WpmfGoogle_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'WpmfGoogle_Service_Coordinate_LocationRecord';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  protected $tokenPaginationType = 'WpmfGoogle_Service_Coordinate_TokenPagination';
  ...
  public function setTokenPagination(WpmfGoogle_Service_Coordinate_TokenPagination $tokenPagination)
  {
...
class WpmfGoogle_Service_Coordinate_LocationRecord extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class WpmfGoogle_Service_Coordinate_Schedule extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $allDay;
...
class WpmfGoogle_Service_Coordinate_Team extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class WpmfGoogle_Service_Coordinate_TeamListResponse extends WpmfGoogle_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'WpmfGoogle_Service_Coordinate_Team';
  protected $itemsDataType = 'array';
  public $kind;
...
class WpmfGoogle_Service_Coordinate_TokenPagination extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
...
class WpmfGoogle_Service_Coordinate_Worker extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class WpmfGoogle_Service_Coordinate_WorkerListResponse extends WpmfGoogle_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'WpmfGoogle_Service_Coordinate_Worker';
  protected $itemsDataType = 'array';
  public $kind;
