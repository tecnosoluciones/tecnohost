 ...
 * @author Google, Inc.
 */
class WpmfGoogle_Service_Tasks extends WpmfGoogle_Service
{
  /** Manage your tasks. */
  const TASKS =
  ...
  public function __construct(WpmfGoogle_Client $client)
  {
    ...
    $this->tasklists = new WpmfGoogle_Service_Tasks_Tasklists_Resource(
        $this,
        $this->serviceName,
        'tasklists',
        array(
    ...
    $this->tasks = new WpmfGoogle_Service_Tasks_Tasks_Resource(
        $this,
        $this->serviceName,
        'tasks',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $tasksService = new WpmfGoogle_Service_Tasks(...);
 *   $tasklists = $tasksService->tasklists;
 *  </code>
 */
class WpmfGoogle_Service_Tasks_Tasklists_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @param string $tasklist Task list identifier.
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Tasks_TaskList
   */
  public function get($tasklist, $optParams = array())
  {
    $params = array('tasklist' => $tasklist);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WpmfGoogle_Service_Tasks_TaskList");
  }
   ...
   * (tasklists.insert)
   *
   * @param WpmfGoogle_TaskList $postBody
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Tasks_TaskList
   */
  public function insert(WpmfGoogle_Service_Tasks_TaskList $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "WpmfGoogle_Service_Tasks_TaskList");
  }
   ...
   * @return WpmfGoogle_Service_Tasks_TaskLists
   */
  public function listTasklists($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WpmfGoogle_Service_Tasks_TaskLists");
  }
   ...
   * @return WpmfGoogle_Service_Tasks_TaskList
   */
  public function patch($tasklist, WpmfGoogle_Service_Tasks_TaskList $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "WpmfGoogle_Service_Tasks_TaskList");
  }
   ...
   * @return WpmfGoogle_Service_Tasks_TaskList
   */
  public function update($tasklist, WpmfGoogle_Service_Tasks_TaskList $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "WpmfGoogle_Service_Tasks_TaskList");
  }
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_Tasks_Tasks_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @param string $task Task identifier.
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Tasks_Task
   */
  public function get($tasklist, $task, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'task' => $task);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WpmfGoogle_Service_Tasks_Task");
  }
   ...
   *
   * @param string $tasklist Task list identifier.
   * @param WpmfGoogle_Task $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return WpmfGoogle_Service_Tasks_Task
   */
  public function insert($tasklist, WpmfGoogle_Service_Tasks_Task $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "WpmfGoogle_Service_Tasks_Task");
  }
   ...
   * timestamp) to filter by. Optional. The default is not to filter by due date.
   * @return WpmfGoogle_Service_Tasks_Tasks
   */
  public function listTasks($tasklist, $optParams = array())
  {
    $params = array('tasklist' => $tasklist);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WpmfGoogle_Service_Tasks_Tasks");
  }
  ...
  public function move($tasklist, $task, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'task' => $task);
    $params = array_merge($params, $optParams);
    return $this->call('move', array($params), "WpmfGoogle_Service_Tasks_Task");
  }
   ...
   * @return WpmfGoogle_Service_Tasks_Task
   */
  public function patch($tasklist, $task, WpmfGoogle_Service_Tasks_Task $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'task' => $task, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "WpmfGoogle_Service_Tasks_Task");
  }
   ...
   * @return WpmfGoogle_Service_Tasks_Task
   */
  public function update($tasklist, $task, WpmfGoogle_Service_Tasks_Task $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'task' => $task, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "WpmfGoogle_Service_Tasks_Task");
  }
}
...
class WpmfGoogle_Service_Tasks_Task extends WpmfGoogle_Collection
{
  ...
  public $id;
  public $kind;
  protected $linksType = 'WpmfGoogle_Service_Tasks_TaskLinks';
...
class WpmfGoogle_Service_Tasks_TaskLinks extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $description;
...
class WpmfGoogle_Service_Tasks_TaskList extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $etag;
...
class WpmfGoogle_Service_Tasks_TaskLists extends WpmfGoogle_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'WpmfGoogle_Service_Tasks_TaskList';
...
class WpmfGoogle_Service_Tasks_Tasks extends WpmfGoogle_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'WpmfGoogle_Service_Tasks_Task';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
