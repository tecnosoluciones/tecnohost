 ...
 * @author Google, Inc.
 */
class WpmfGoogle_Service_AppState extends WpmfGoogle_Service
{
  ...
  public function __construct(WpmfGoogle_Client $client)
  {
    ...
    $this->states = new WpmfGoogle_Service_AppState_States_Resource(
        $this,
        $this->serviceName,
        'states',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $appstateService = new WpmfGoogle_Service_AppState(...);
 *   $states = $appstateService->states;
 *  </code>
 */
class WpmfGoogle_Service_AppState_States_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @return WpmfGoogle_Service_AppState_WriteResult
   */
  public function clear($stateKey, $optParams = array())
  {
    $params = array('stateKey' => $stateKey);
    $params = array_merge($params, $optParams);
    return $this->call('clear', array($params), "WpmfGoogle_Service_AppState_WriteResult");
  }
   ...
   * @param int $stateKey The key for the data to be retrieved.
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_AppState_GetResponse
   */
  public function get($stateKey, $optParams = array())
  {
    $params = array('stateKey' => $stateKey);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WpmfGoogle_Service_AppState_GetResponse");
  }
   ...
   * the version number
   * @return WpmfGoogle_Service_AppState_ListResponse
   */
  public function listStates($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WpmfGoogle_Service_AppState_ListResponse");
  }
   ...
   *
   * @param int $stateKey The key for the data to be retrieved.
   * @param WpmfGoogle_UpdateRequest $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return WpmfGoogle_Service_AppState_WriteResult
   */
  public function update($stateKey, WpmfGoogle_Service_AppState_UpdateRequest $postBody, $optParams = array())
  {
    $params = array('stateKey' => $stateKey, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "WpmfGoogle_Service_AppState_WriteResult");
  }
}
...
class WpmfGoogle_Service_AppState_GetResponse extends WpmfGoogle_Model
{
...
class WpmfGoogle_Service_AppState_ListResponse extends WpmfGoogle_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'WpmfGoogle_Service_AppState_GetResponse';
...
class WpmfGoogle_Service_AppState_UpdateRequest extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $data;
...
class WpmfGoogle_Service_AppState_WriteResult extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $currentStateVersion;
