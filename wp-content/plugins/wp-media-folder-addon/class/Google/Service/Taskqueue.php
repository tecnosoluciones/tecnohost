 ...
 * @author Google, Inc.
 */
class WpmfGoogle_Service_Taskqueue extends WpmfGoogle_Service
{
  ...
  public function __construct(WpmfGoogle_Client $client)
  {
    ...
    $this->taskqueues = new WpmfGoogle_Service_Taskqueue_Taskqueues_Resource(
        $this,
        $this->serviceName,
        'taskqueues',
        array(
    ...
    $this->tasks = new WpmfGoogle_Service_Taskqueue_Tasks_Resource(
        $this,
        $this->serviceName,
        'tasks',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $taskqueueService = new WpmfGoogle_Service_Taskqueue(...);
 *   $taskqueues = $taskqueueService->taskqueues;
 *  </code>
 */
class WpmfGoogle_Service_Taskqueue_Taskqueues_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @return WpmfGoogle_Service_Taskqueue_TaskQueue
   */
  public function get($project, $taskqueue, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WpmfGoogle_Service_Taskqueue_TaskQueue");
  }
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_Taskqueue_Tasks_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Taskqueue_Task
   */
  public function get($project, $taskqueue, $task, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'task' => $task);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WpmfGoogle_Service_Taskqueue_Task");
  }
   ...
   * @return WpmfGoogle_Service_Taskqueue_Task
   */
  public function insert($project, $taskqueue, WpmfGoogle_Service_Taskqueue_Task $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "WpmfGoogle_Service_Taskqueue_Task");
  }
   ...
   * available tag
   * @return WpmfGoogle_Service_Taskqueue_Tasks
   */
  public function lease($project, $taskqueue, $numTasks, $leaseSecs, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('lease', array($params), "WpmfGoogle_Service_Taskqueue_Tasks");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Taskqueue_Tasks2
   */
  public function listTasks($project, $taskqueue, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WpmfGoogle_Service_Taskqueue_Tasks2");
  }
   ...
   * @return WpmfGoogle_Service_Taskqueue_Task
   */
  public function patch($project, $taskqueue, $task, $newLeaseSeconds, WpmfGoogle_Service_Taskqueue_Task $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'task' => $task, 'newLeaseSeconds' => $newLeaseSeconds, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "WpmfGoogle_Service_Taskqueue_Task");
  }
   ...
   * @return WpmfGoogle_Service_Taskqueue_Task
   */
  public function update($project, $taskqueue, $task, $newLeaseSeconds, WpmfGoogle_Service_Taskqueue_Task $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'task' => $task, 'newLeaseSeconds' => $newLeaseSeconds, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "WpmfGoogle_Service_Taskqueue_Task");
  }
}
...
class WpmfGoogle_Service_Taskqueue_Task extends WpmfGoogle_Model
{
...
class WpmfGoogle_Service_Taskqueue_TaskQueue extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $aclType = 'WpmfGoogle_Service_Taskqueue_TaskQueueAcl';
  protected $aclDataType = '';
  public $id;
  public $kind;
  public $maxLeases;
  protected $statsType = 'WpmfGoogle_Service_Taskqueue_TaskQueueStats';
  protected $statsDataType = '';


  public function setAcl(WpmfGoogle_Service_Taskqueue_TaskQueueAcl $acl)
  {
    $this->acl = $acl;
  }
  ...
  public function setStats(WpmfGoogle_Service_Taskqueue_TaskQueueStats $stats)
  {
    $this->stats = $stats;
  }
...
class WpmfGoogle_Service_Taskqueue_TaskQueueAcl extends WpmfGoogle_Collection
{
...
class WpmfGoogle_Service_Taskqueue_TaskQueueStats extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class WpmfGoogle_Service_Taskqueue_Tasks extends WpmfGoogle_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'WpmfGoogle_Service_Taskqueue_Task';
...
class WpmfGoogle_Service_Taskqueue_Tasks2 extends WpmfGoogle_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
