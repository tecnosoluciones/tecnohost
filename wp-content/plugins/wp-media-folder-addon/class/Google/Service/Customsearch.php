 ...
 * @author Google, Inc.
 */
class WpmfGoogle_Service_Customsearch extends WpmfGoogle_Service
{
  ...
  public function __construct(WpmfGoogle_Client $client)
  {
    ...
    $this->cse = new WpmfGoogle_Service_Customsearch_Cse_Resource(
        $this,
        $this->serviceName,
        'cse',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $customsearchService = new WpmfGoogle_Service_Customsearch(...);
 *   $cse = $customsearchService->cse;
 *  </code>
 */
class WpmfGoogle_Service_Customsearch_Cse_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @return WpmfGoogle_Service_Customsearch_Search
   */
  public function listCse($q, $optParams = array())
  {
    $params = array('q' => $q);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WpmfGoogle_Service_Customsearch_Search");
  }
}
...
class WpmfGoogle_Service_Customsearch_Context extends WpmfGoogle_Collection
{
  protected $collection_key = 'facets';
  protected $internal_gapi_mappings = array(
  );
  protected $facetsType = 'WpmfGoogle_Service_Customsearch_ContextFacets';
...
class WpmfGoogle_Service_Customsearch_ContextFacets extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
...
class WpmfGoogle_Service_Customsearch_Promotion extends WpmfGoogle_Collection
{
  protected $collection_key = 'bodyLines';
  protected $internal_gapi_mappings = array(
  );
  protected $bodyLinesType = 'WpmfGoogle_Service_Customsearch_PromotionBodyLines';
  protected $bodyLinesDataType = 'array';
  public $displayLink;
  public $htmlTitle;
  protected $imageType = 'WpmfGoogle_Service_Customsearch_PromotionImage';
  ...
  public function setImage(WpmfGoogle_Service_Customsearch_PromotionImage $image)
  {
    $this->image = $image;
  }
...
class WpmfGoogle_Service_Customsearch_PromotionBodyLines extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $htmlTitle;
...
class WpmfGoogle_Service_Customsearch_PromotionImage extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $height;
...
class WpmfGoogle_Service_Customsearch_Query extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $count;
...
class WpmfGoogle_Service_Customsearch_Result extends WpmfGoogle_Collection
{
  ...
  public $htmlSnippet;
  public $htmlTitle;
  protected $imageType = 'WpmfGoogle_Service_Customsearch_ResultImage';
  protected $imageDataType = '';
  public $kind;
  protected $labelsType = 'WpmfGoogle_Service_Customsearch_ResultLabels';
  ...
  public function setImage(WpmfGoogle_Service_Customsearch_ResultImage $image)
  {
    $this->image = $image;
  }
  public function getImage()
...
class WpmfGoogle_Service_Customsearch_ResultImage extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $byteSize;
...
class WpmfGoogle_Service_Customsearch_ResultLabels extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
        "labelWithOp" => "label_with_op",
  );
...
class WpmfGoogle_Service_Customsearch_ResultPagemap extends WpmfGoogle_Model
{
}

class WpmfGoogle_Service_Customsearch_ResultPagemapItemElement extends WpmfGoogle_Model
{
}

class WpmfGoogle_Service_Customsearch_Search extends WpmfGoogle_Collection
{
  protected $collection_key = 'promotions';
  protected $internal_gapi_mappings = array(
  );
  protected $contextType = 'WpmfGoogle_Service_Customsearch_Context';
  protected $contextDataType = '';
  protected $itemsType = 'WpmfGoogle_Service_Customsearch_Result';
  protected $itemsDataType = 'array';
  public $kind;
  protected $promotionsType = 'WpmfGoogle_Service_Customsearch_Promotion';
  protected $promotionsDataType = 'array';
  protected $queriesType = 'WpmfGoogle_Service_Customsearch_Query';
  protected $queriesDataType = 'map';
  protected $searchInformationType = 'WpmfGoogle_Service_Customsearch_SearchSearchInformation';
  protected $searchInformationDataType = '';
  protected $spellingType = 'WpmfGoogle_Service_Customsearch_SearchSpelling';
  protected $spellingDataType = '';
  protected $urlType = 'WpmfGoogle_Service_Customsearch_SearchUrl';
  protected $urlDataType = '';


  public function setContext(WpmfGoogle_Service_Customsearch_Context $context)
  {
  ...
  public function setSearchInformation(WpmfGoogle_Service_Customsearch_SearchSearchInformation $searchInformation)
  {
  ...
  public function setSpelling(WpmfGoogle_Service_Customsearch_SearchSpelling $spelling)
  {
  ...
  public function setUrl(WpmfGoogle_Service_Customsearch_SearchUrl $url)
  {
    $this->url = $url;
  }
  public function getUrl()
...
class WpmfGoogle_Service_Customsearch_SearchQueries extends WpmfGoogle_Model
{
}

class WpmfGoogle_Service_Customsearch_SearchSearchInformation extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class WpmfGoogle_Service_Customsearch_SearchSpelling extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class WpmfGoogle_Service_Customsearch_SearchUrl extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $template;
