 ...
 * @author Google, Inc.
 */
class WpmfGoogle_Service_GroupsMigration extends WpmfGoogle_Service
{
  ...
  public function __construct(WpmfGoogle_Client $client)
  {
    ...
    $this->archive = new WpmfGoogle_Service_GroupsMigration_Archive_Resource(
        $this,
        $this->serviceName,
        'archive',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $groupsmigrationService = new WpmfGoogle_Service_GroupsMigration(...);
 *   $archive = $groupsmigrationService->archive;
 *  </code>
 */
class WpmfGoogle_Service_GroupsMigration_Archive_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @return WpmfGoogle_Service_GroupsMigration_Groups
   */
  public function insert($groupId, $optParams = array())
  {
    $params = array('groupId' => $groupId);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "WpmfGoogle_Service_GroupsMigration_Groups");
  }
}
...
class WpmfGoogle_Service_GroupsMigration_Groups extends WpmfGoogle_Model
{
