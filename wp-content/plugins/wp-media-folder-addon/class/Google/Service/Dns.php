 ...
 * @author Google, Inc.
 */
class WpmfGoogle_Service_Dns extends WpmfGoogle_Service
{
  ...
  public function __construct(WpmfGoogle_Client $client)
  {
    ...
    $this->changes = new WpmfGoogle_Service_Dns_Changes_Resource(
        $this,
        $this->serviceName,
        'changes',
        array(
    ...
    $this->managedZones = new WpmfGoogle_Service_Dns_ManagedZones_Resource(
        $this,
        $this->serviceName,
        'managedZones',
        array(
    ...
    $this->projects = new WpmfGoogle_Service_Dns_Projects_Resource(
        $this,
        $this->serviceName,
        'projects',
        array(
    ...
    $this->resourceRecordSets = new WpmfGoogle_Service_Dns_ResourceRecordSets_Resource(
        $this,
        $this->serviceName,
        'resourceRecordSets',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $dnsService = new WpmfGoogle_Service_Dns(...);
 *   $changes = $dnsService->changes;
 *  </code>
 */
class WpmfGoogle_Service_Dns_Changes_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @param WpmfGoogle_Change $postBody
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Dns_Change
   */
  public function create($project, $managedZone, WpmfGoogle_Service_Dns_Change $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "WpmfGoogle_Service_Dns_Change");
  }
  ...
  public function get($project, $managedZone, $changeId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WpmfGoogle_Service_Dns_Change");
  }
   ...
   * 'descending'.
   * @return WpmfGoogle_Service_Dns_ChangesListResponse
   */
  public function listChanges($project, $managedZone, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WpmfGoogle_Service_Dns_ChangesListResponse");
  }
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_Dns_ManagedZones_Resource extends WpmfGoogle_Service_Resource
{
   ...
   *
   * @param string $project Identifies the project addressed by this request.
   * @param WpmfGoogle_ManagedZone $postBody
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Dns_ManagedZone
   */
  public function create($project, WpmfGoogle_Service_Dns_ManagedZone $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "WpmfGoogle_Service_Dns_ManagedZone");
  }
  ...
  public function get($project, $managedZone, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WpmfGoogle_Service_Dns_ManagedZone");
  }
   ...
   * @opt_param int maxResults Optional. Maximum number of results to be returned.
   * If unspecified, the server will decide how many results to return.
   * @return WpmfGoogle_Service_Dns_ManagedZonesListResponse
   */
  public function listManagedZones($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WpmfGoogle_Service_Dns_ManagedZonesListResponse");
  }
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_Dns_Projects_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @param string $project Identifies the project addressed by this request.
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Dns_Project
   */
  public function get($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WpmfGoogle_Service_Dns_Project");
  }
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_Dns_ResourceRecordSets_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @return WpmfGoogle_Service_Dns_ResourceRecordSetsListResponse
   */
  public function listResourceRecordSets($project, $managedZone, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WpmfGoogle_Service_Dns_ResourceRecordSetsListResponse");
  }
}
...
class WpmfGoogle_Service_Dns_Change extends WpmfGoogle_Collection
{
  protected $collection_key = 'deletions';
  protected $internal_gapi_mappings = array(
  );
  protected $additionsType = 'WpmfGoogle_Service_Dns_ResourceRecordSet';
  protected $additionsDataType = 'array';
  protected $deletionsType = 'WpmfGoogle_Service_Dns_ResourceRecordSet';
...
class WpmfGoogle_Service_Dns_ChangesListResponse extends WpmfGoogle_Collection
{
  protected $collection_key = 'changes';
  protected $internal_gapi_mappings = array(
  );
  protected $changesType = 'WpmfGoogle_Service_Dns_Change';
...
class WpmfGoogle_Service_Dns_ManagedZone extends WpmfGoogle_Collection
{
...
class WpmfGoogle_Service_Dns_ManagedZonesListResponse extends WpmfGoogle_Collection
{
  protected $collection_key = 'managedZones';
  protected $internal_gapi_mappings = array(
  );
  public $kind;
  protected $managedZonesType = 'WpmfGoogle_Service_Dns_ManagedZone';
...
class WpmfGoogle_Service_Dns_Project extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
  public $kind;
  public $number;
  protected $quotaType = 'WpmfGoogle_Service_Dns_Quota';
  ...
  public function setQuota(WpmfGoogle_Service_Dns_Quota $quota)
  {
    $this->quota = $quota;
  }
...
class WpmfGoogle_Service_Dns_Quota extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
...
class WpmfGoogle_Service_Dns_ResourceRecordSet extends WpmfGoogle_Collection
{
...
class WpmfGoogle_Service_Dns_ResourceRecordSetsListResponse extends WpmfGoogle_Collection
{
  ...
  public $kind;
  public $nextPageToken;
  protected $rrsetsType = 'WpmfGoogle_Service_Dns_ResourceRecordSet';
