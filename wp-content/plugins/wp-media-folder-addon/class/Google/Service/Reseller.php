 ...
 * @author Google, Inc.
 */
class WpmfGoogle_Service_Reseller extends WpmfGoogle_Service
{
  ...
  public function __construct(WpmfGoogle_Client $client)
  {
    ...
    $this->customers = new WpmfGoogle_Service_Reseller_Customers_Resource(
        $this,
        $this->serviceName,
        'customers',
        array(
    ...
    $this->subscriptions = new WpmfGoogle_Service_Reseller_Subscriptions_Resource(
        $this,
        $this->serviceName,
        'subscriptions',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $resellerService = new WpmfGoogle_Service_Reseller(...);
 *   $customers = $resellerService->customers;
 *  </code>
 */
class WpmfGoogle_Service_Reseller_Customers_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @return WpmfGoogle_Service_Reseller_Customer
   */
  public function get($customerId, $optParams = array())
  {
    $params = array('customerId' => $customerId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WpmfGoogle_Service_Reseller_Customer");
  }

  /**
   * Creates a customer resource if one does not already exist. (customers.insert)
   *
   * @param WpmfGoogle_Customer $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return WpmfGoogle_Service_Reseller_Customer
   */
  public function insert(WpmfGoogle_Service_Reseller_Customer $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "WpmfGoogle_Service_Reseller_Customer");
  }
   ...
   * @return WpmfGoogle_Service_Reseller_Customer
   */
  public function patch($customerId, WpmfGoogle_Service_Reseller_Customer $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "WpmfGoogle_Service_Reseller_Customer");
  }
   ...
   * @return WpmfGoogle_Service_Reseller_Customer
   */
  public function update($customerId, WpmfGoogle_Service_Reseller_Customer $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "WpmfGoogle_Service_Reseller_Customer");
  }
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_Reseller_Subscriptions_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * customer
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Reseller_Subscription
   */
  public function activate($customerId, $subscriptionId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('activate', array($params), "WpmfGoogle_Service_Reseller_Subscription");
  }
   ...
   * @param string $subscriptionId Id of the subscription, which is unique for a
   * customer
   * @param WpmfGoogle_ChangePlanRequest $postBody
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Reseller_Subscription
   */
  public function changePlan($customerId, $subscriptionId, WpmfGoogle_Service_Reseller_ChangePlanRequest $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('changePlan', array($params), "WpmfGoogle_Service_Reseller_Subscription");
  }
   ...
   * @param string $subscriptionId Id of the subscription, which is unique for a
   * customer
   * @param WpmfGoogle_RenewalSettings $postBody
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Reseller_Subscription
   */
  public function changeRenewalSettings($customerId, $subscriptionId, WpmfGoogle_Service_Reseller_RenewalSettings $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('changeRenewalSettings', array($params), "WpmfGoogle_Service_Reseller_Subscription");
  }
   ...
   * @param string $subscriptionId Id of the subscription, which is unique for a
   * customer
   * @param WpmfGoogle_Seats $postBody
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Reseller_Subscription
   */
  public function changeSeats($customerId, $subscriptionId, WpmfGoogle_Service_Reseller_Seats $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('changeSeats', array($params), "WpmfGoogle_Service_Reseller_Subscription");
  }
  ...
  public function get($customerId, $subscriptionId, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WpmfGoogle_Service_Reseller_Subscription");
  }
   ...
   * @return WpmfGoogle_Service_Reseller_Subscription
   */
  public function insert($customerId, WpmfGoogle_Service_Reseller_Subscription $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "WpmfGoogle_Service_Reseller_Subscription");
  }
   ...
   * @return WpmfGoogle_Service_Reseller_Subscriptions
   */
  public function listSubscriptions($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WpmfGoogle_Service_Reseller_Subscriptions");
  }
  ...
  public function startPaidService($customerId, $subscriptionId, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId);
    $params = array_merge($params, $optParams);
    return $this->call('startPaidService', array($params), "WpmfGoogle_Service_Reseller_Subscription");
  }
  ...
  public function suspend($customerId, $subscriptionId, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId);
    $params = array_merge($params, $optParams);
    return $this->call('suspend', array($params), "WpmfGoogle_Service_Reseller_Subscription");
  }
}
...
class WpmfGoogle_Service_Reseller_Address extends WpmfGoogle_Model
{
...
class WpmfGoogle_Service_Reseller_ChangePlanRequest extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
  ...
  protected $seatsType = 'WpmfGoogle_Service_Reseller_Seats';
  ...
  public function setSeats(WpmfGoogle_Service_Reseller_Seats $seats)
  {
    $this->seats = $seats;
  }
...
class WpmfGoogle_Service_Reseller_Customer extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  ...
  public $kind;
  public $phoneNumber;
  protected $postalAddressType = 'WpmfGoogle_Service_Reseller_Address';
  ...
  public function setPostalAddress(WpmfGoogle_Service_Reseller_Address $postalAddress)
  {
...
class WpmfGoogle_Service_Reseller_RenewalSettings extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
...
class WpmfGoogle_Service_Reseller_Seats extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
...
class WpmfGoogle_Service_Reseller_Subscription extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  ...
  public $customerId;
  public $kind;
  protected $planType = 'WpmfGoogle_Service_Reseller_SubscriptionPlan';
  protected $planDataType = '';
  public $purchaseOrderId;
  protected $renewalSettingsType = 'WpmfGoogle_Service_Reseller_RenewalSettings';
  ...
  protected $transferInfoType = 'WpmfGoogle_Service_Reseller_SubscriptionTransferInfo';
  protected $transferInfoDataType = '';
  protected $trialSettingsType = 'WpmfGoogle_Service_Reseller_SubscriptionTrialSettings';
  ...
  public function setPlan(WpmfGoogle_Service_Reseller_SubscriptionPlan $plan)
  {
    $this->plan = $plan;
  }
  ...
  public function setRenewalSettings(WpmfGoogle_Service_Reseller_RenewalSettings $renewalSettings)
  {
  ...
  public function setTransferInfo(WpmfGoogle_Service_Reseller_SubscriptionTransferInfo $transferInfo)
  {
  ...
  public function setTrialSettings(WpmfGoogle_Service_Reseller_SubscriptionTrialSettings $trialSettings)
  {
...
class WpmfGoogle_Service_Reseller_SubscriptionPlan extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $commitmentIntervalType = 'WpmfGoogle_Service_Reseller_SubscriptionPlanCommitmentInterval';
  protected $commitmentIntervalDataType = '';
  public $isCommitmentPlan;
  public $planName;


  public function setCommitmentInterval(WpmfGoogle_Service_Reseller_SubscriptionPlanCommitmentInterval $commitmentInterval)
  {
...
class WpmfGoogle_Service_Reseller_SubscriptionPlanCommitmentInterval extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $endTime;
...
class WpmfGoogle_Service_Reseller_SubscriptionTransferInfo extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class WpmfGoogle_Service_Reseller_SubscriptionTrialSettings extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $isInTrial;
...
class WpmfGoogle_Service_Reseller_Subscriptions extends WpmfGoogle_Collection
{
  ...
  protected $subscriptionsType = 'WpmfGoogle_Service_Reseller_Subscription';
