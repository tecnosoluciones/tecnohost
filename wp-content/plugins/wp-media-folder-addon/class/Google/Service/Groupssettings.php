 ...
 * @author Google, Inc.
 */
class WpmfGoogle_Service_Groupssettings extends WpmfGoogle_Service
{
  ...
  public function __construct(WpmfGoogle_Client $client)
  {
    ...
    $this->groups = new WpmfGoogle_Service_Groupssettings_Groups_Resource(
        $this,
        $this->serviceName,
        'groups',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $groupssettingsService = new WpmfGoogle_Service_Groupssettings(...);
 *   $groups = $groupssettingsService->groups;
 *  </code>
 */
class WpmfGoogle_Service_Groupssettings_Groups_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @return WpmfGoogle_Service_Groupssettings_Groups
   */
  public function get($groupUniqueId, $optParams = array())
  {
    $params = array('groupUniqueId' => $groupUniqueId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WpmfGoogle_Service_Groupssettings_Groups");
  }
   ...
   *
   * @param string $groupUniqueId The resource ID
   * @param WpmfGoogle_Groups $postBody
   * @param array $optParams Optional parameters.
   * @return WpmfGoogle_Service_Groupssettings_Groups
   */
  public function patch($groupUniqueId, WpmfGoogle_Service_Groupssettings_Groups $postBody, $optParams = array())
  {
    $params = array('groupUniqueId' => $groupUniqueId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "WpmfGoogle_Service_Groupssettings_Groups");
  }
   ...
   * @return WpmfGoogle_Service_Groupssettings_Groups
   */
  public function update($groupUniqueId, WpmfGoogle_Service_Groupssettings_Groups $postBody, $optParams = array())
  {
    $params = array('groupUniqueId' => $groupUniqueId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "WpmfGoogle_Service_Groupssettings_Groups");
  }
}
...
class WpmfGoogle_Service_Groupssettings_Groups extends WpmfGoogle_Model
{
