 ...
 * @author Google, Inc.
 */
class WpmfGoogle_Service_Audit extends WpmfGoogle_Service
{
  ...
  public function __construct(WpmfGoogle_Client $client)
  {
    ...
    $this->activities = new WpmfGoogle_Service_Audit_Activities_Resource(
        $this,
        $this->serviceName,
        'activities',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $auditService = new WpmfGoogle_Service_Audit(...);
 *   $activities = $auditService->activities;
 *  </code>
 */
class WpmfGoogle_Service_Audit_Activities_Resource extends WpmfGoogle_Service_Resource
{
   ...
   * @return WpmfGoogle_Service_Audit_Activities
   */
  public function listActivities($customerId, $applicationId, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "WpmfGoogle_Service_Audit_Activities");
  }
}
...
class WpmfGoogle_Service_Audit_Activities extends WpmfGoogle_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'WpmfGoogle_Service_Audit_Activity';
...
class WpmfGoogle_Service_Audit_Activity extends WpmfGoogle_Collection
{
  protected $collection_key = 'events';
  protected $internal_gapi_mappings = array(
  );
  protected $actorType = 'WpmfGoogle_Service_Audit_ActivityActor';
  protected $actorDataType = '';
  protected $eventsType = 'WpmfGoogle_Service_Audit_ActivityEvents';
  protected $eventsDataType = 'array';
  protected $idType = 'WpmfGoogle_Service_Audit_ActivityId';
  ...
  public function setActor(WpmfGoogle_Service_Audit_ActivityActor $actor)
  {
    $this->actor = $actor;
  }
  ...
  public function setId(WpmfGoogle_Service_Audit_ActivityId $id)
  {
    $this->id = $id;
  }
...
class WpmfGoogle_Service_Audit_ActivityActor extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class WpmfGoogle_Service_Audit_ActivityEvents extends WpmfGoogle_Collection
{
  ...
  public $eventType;
  public $name;
  protected $parametersType = 'WpmfGoogle_Service_Audit_ActivityEventsParameters';
...
class WpmfGoogle_Service_Audit_ActivityEventsParameters extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $name;
...
class WpmfGoogle_Service_Audit_ActivityId extends WpmfGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $applicationId;
