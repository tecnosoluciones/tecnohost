 ...
 */
class WpmfGoogle_Cache_File extends WpmfGoogle_Cache_Abstract
{
  ...
  /**
   * @var WpmfGoogle_Client the current client
   */
  private $client;
  ...
  public function delete($key)
  {
    ...
    if (file_exists($file) && !unlink($file)) {
      ...
      throw new WpmfGoogle_Cache_Exception("Cache file could not be deleted");
    }
  ...
  private function getCacheDir($file, $forWrite)
  {
    ...
    if ($forWrite && ! is_dir($storageDir)) {
      if (! mkdir($storageDir, 0755, true)) {
        ...
        throw new WpmfGoogle_Cache_Exception("Could not create storage directory: $storageDir");
      }
    }
    return $storageDir;
  }
