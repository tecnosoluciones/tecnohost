 ...
 */
class WpmfGoogle_Cache_Memcache extends WpmfGoogle_Cache_Abstract
{
  ...
  public function __construct(WpmfGoogle_Client $client)
  {
    if (!function_exists('memcache_connect') && !class_exists("Memcached")) {
      ...
      throw new WpmfGoogle_Cache_Exception($error);
    }
   ...
   * @param string $key
   * @param string $value
   * @throws WpmfGoogle_Cache_Exception
   */
  public function set($key, $value)
  {
    ...
    if ($rc == false) {
      ...
      throw new WpmfGoogle_Cache_Exception("Couldn't store data in cache");
    }
