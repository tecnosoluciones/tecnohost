<?php
if ( ( class_exists( 'LearnDash_Settings_Section' ) ) && ( !class_exists( 'LearnDash_Settings_Section_Translations_Learndash_Restric_Content_Pro' ) ) ) {
	class LearnDash_Settings_Section_Translations_Learndash_Restric_Content_Pro extends LearnDash_Settings_Section {

		// Must match the Text Domain
		private $project_slug = 'learndash-restrict-content-pro';
		...
		function __construct() {
			...
			$this->settings_section_label			=	__( 'LearnDash Restric Content Pro', 'learndash-restrict-content-pro' );
			...
			if ( class_exists( 'LearnDash_Translations' ) ) {
				...
				if ( method_exists( 'LearnDash_Translations', 'register_translation_slug' ) ) {
					...
					LearnDash_Translations::register_translation_slug( $this->project_slug, LEARNDASH_RESTRICT_CONTENT_PRO_PLUGIN_PATH . 'languages' );
				} 
			} 
	...
	add_action( 'init', function() {
		LearnDash_Settings_Section_Translations_Learndash_Restric_Content_Pro::add_section_instance();
	} );
}
