...
final class Manager {
	...
	public function pa_countdown_options() {
		...
		$options = array(
			'styles'          => array(
				...
				'flipping' => __( 'Flip', 'premium-addons-for-elementor' ),
			),
			'style_condition' => '',
		);
	...
	public function add_select_field_style( $elem ) {
		...
		$elem->start_controls_section(
			'select_field_style',
			array(
				'label'     => __( 'Select Field', 'premium-addons-for-elementor' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => array(
					'query_type'           => 'post',
	...
	public function add_mobile_menu_carousel_controls( $elem ) {
		...
		$elem->add_responsive_control(
			'items_to_show',
			array(
				'label'              => __( 'Items to Show', 'premium-addons-for-elementor' ),
				'type'               => Controls_Manager::NUMBER,
				'default'            => 3,
				'condition'          => array(
					'carousel' => 'yes',
	...
	public function add_mobile_menu_badge_style( $elem ) {
		...
		$elem->add_control(
			'badge_text_color',
			array(
				'label'     => __( 'Badge Text Color', 'premium-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$elem->add_control(
			...
			array(
				'label'     => __( 'Badge Background', 'premium-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
	...
	public function add_mobile_menu_badge_style_tab( $elem ) {
		...
		$elem->start_controls_section(
			'items_badge_style',
			array(
				'label' => __( 'Item Badge', 'premium-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
	...
	public function add_mobile_menu_indicator_carousel_style( $elem ) {
		...
		$elem->start_controls_section(
			...
			array(
				'label'     => __( 'Active Item Indicator', 'premium-addons-for-elementor' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => array(
	...
	public function add_atext_highlight_controls( $elem ) {
		...
		$elem->add_control(
			...
			array(
				...
				'options'     => array(
					'circle'    => __( 'Circle', 'premium-addons-for-elementor' ),
					'wavy'      => __( 'Wavy Zigzag', 'premium-addons-for-elementor' ),
					'underline' => __( 'Underline', 'premium-addons-for-elementor' ),
					'double'    => __( 'Double Underline', 'premium-addons-for-elementor' ),
					'zigzag'    => __( 'Underline Zigzag', 'premium-addons-for-elementor' ),
					'strike'    => __( 'Strikethrough', 'premium-addons-for-elementor' ),
					'cross'     => __( 'Cross X', 'premium-addons-for-elementor' ),
				),
				'default'     => 'circle',
				'label_block' => true,
				'condition'   => array(
		...
		$elem->add_control(
			'reveal_notice',
			array(
				'raw'             => __( 'To see this effect, you need to set background color from Style tab.', 'premium-addons-for-elementor' ),
				'type'            => Controls_Manager::RAW_HTML,
		...
		$elem->add_control(
			'lines_notice',
			array(
				'raw'             => __( 'You need to set colors for this effect from style tab.', 'premium-addons-for-elementor' ),
				'type'            => Controls_Manager::RAW_HTML,
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-warning',
				'condition'       => array(
					'style'            => 'highlight',
	...
	public function add_atext_shape_style( $elem ) {
		...
		$elem->add_control(
			'rounded_edges',
			array(
				'label'     => __( 'Rounded Edges', 'premium-addons-for-elementor' ),
				'type'      => Controls_Manager::SWITCHER,
				'selectors' => array(
	...
	public function add_woo_cats_individual_style( $elem ) {
		...
		$repeater->add_group_control(
			...
			array(
				...
				'fields_options' => array(
					'border' => array(
						'label' => __( 'Border Type', 'premium-addons-for-elementor' ),
					),
				),
				'selector'       => '{{WRAPPER}} {{CURRENT_ITEM}}',
			)
		...
		$repeater->add_group_control(
			...
			array(
				'fields_options' => array(
					'border' => array(
						'label' => __( 'Hover Border Type', 'premium-addons-for-elementor' ),
					),
				),
    ...
    public function add_woo_cta_text_controls( $elem ) {
        ...
        $elem->add_control(
			...
			array(
				...
				'default'     => __( 'Add to Wishlist', 'premium-addons-for-elementor' ),
				'type'        => Controls_Manager::TEXT,
				'dynamic'     => array( 'active' => true ),
				'label_block' => true,
				'condition'   => array(
        ...
        $elem->add_control(
			'wishlist_message',
			array(
				'label'       => __( 'Added to Wishlist Message', 'premium-addons-for-elementor' ),
				'default'     => __( 'Product added!', 'premium-addons-for-elementor' ),
				'type'        => Controls_Manager::TEXT,
				'dynamic'     => array( 'active' => true ),
				'label_block' => true,
				'condition'   => array(
		...
		$elem->add_control(
			...
			array(
				'label'       => __( 'Text Remove', 'premium-addons-for-elementor' ),
				'default'     => __( 'Remove From Wishlist', 'premium-addons-for-elementor' ),
				'type'        => Controls_Manager::TEXT,
				'dynamic'     => array( 'active' => true ),
				'label_block' => true,
				'condition'   => array(
		...
		$elem->add_control(
			...
			array(
				'label'       => __( 'Text', 'premium-addons-for-elementor' ),
				'default'     => __( 'Add to Compare', 'premium-addons-for-elementor' ),
				'type'        => Controls_Manager::TEXT,
				'dynamic'     => array( 'active' => true ),
				'label_block' => true,
				'condition'   => array(
		...
		$elem->add_control(
			'compare_remove_text',
			array(
				'label'       => __( 'Remove Text', 'premium-addons-for-elementor' ),
				'default'     => __( 'Remove From Compare', 'premium-addons-for-elementor' ),
				'type'        => Controls_Manager::TEXT,
				'dynamic'     => array( 'active' => true ),
				'label_block' => true,
				'condition'   => array(
    ...
    public function add_woo_mini_cart_window_controls( $elem ) {
		...
		$elem->add_responsive_control(
			'mini_window_pos',
			array(
				'label'     => __( 'Mini Window Position', 'premium-addons-for-elementor' ),
				'type'      => Controls_Manager::CHOOSE,
