...
class Premium_Google_Reviews extends Widget_Base {
	...
	protected function register_controls() { // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
		...
		$docs = array(
			...
			'https://premiumaddons.com/docs/getting-google-api-key-for-elementor-widgets//' => __( 'How to get an API key for Google Reviews »', 'premium-addons-pro' ),
	...
	protected function render() {
		...
		if ( false === $response ) {
			...
			if ( isset( $response->result->reviews ) && is_array( $stored_revs ) ) {
		...
		$reviews = is_array( $stored_revs ) && count( $stored_revs ) > 0 ? $stored_revs : $place->reviews;
