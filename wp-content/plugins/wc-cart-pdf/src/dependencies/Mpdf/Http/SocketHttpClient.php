...
use WCCartPDF\Mpdf\PsrHttpMessageShim\Response;
use WCCartPDF\Mpdf\PsrHttpMessageShim\Stream;
...
class SocketHttpClient implements \WCCartPDF\Mpdf\Http\ClientInterface, \WCCartPDF\Psr\Log\LoggerAwareInterface
{
