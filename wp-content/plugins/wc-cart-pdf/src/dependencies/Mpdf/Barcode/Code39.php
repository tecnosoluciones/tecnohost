 ...
 */
class Code39 extends \WCCartPDF\Mpdf\Barcode\AbstractBarcode implements \WCCartPDF\Mpdf\Barcode\BarcodeInterface
{
	...
	private function init($code, $printRatio, $extended, $checksum)
	{
		...
		if ($code === false) {
			throw new \WCCartPDF\Mpdf\Barcode\BarcodeException(sprintf('Invalid CODE39 barcode value "%s"', $code));
		}
