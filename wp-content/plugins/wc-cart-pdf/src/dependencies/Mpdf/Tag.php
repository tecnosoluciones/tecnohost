...
class Tag
{
	...
	/**
	 * @param \WCCartPDF\Mpdf\Mpdf $mpdf
	 * @param \WCCartPDF\Mpdf\Cache $cache
	 * @param \WCCartPDF\Mpdf\CssManager $cssManager
	 * @param \WCCartPDF\Mpdf\Form $form
	 * @param \WCCartPDF\Mpdf\Otl $otl
	 * @param \WCCartPDF\Mpdf\TableOfContents $tableOfContents
	 * @param \WCCartPDF\Mpdf\SizeConverter $sizeConverter
	 * @param \WCCartPDF\Mpdf\Color\ColorConverter $colorConverter
	 * @param \WCCartPDF\Mpdf\Image\ImageProcessor $imageProcessor
	 * @param \WCCartPDF\Mpdf\Language\LanguageToFontInterface $languageToFont
	 */
