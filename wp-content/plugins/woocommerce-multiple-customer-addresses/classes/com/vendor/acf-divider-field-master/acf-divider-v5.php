<?php
//https://www.codee.io/make-acf-look-great/
...
class acf_field_divider extends acf_field {
	...
	*/
	...
	function field_group_admin_head() {
		wp_register_script( 'acf-input-divider', plugin_dir_url( __FILE__ ) ."js/input.js" );
		wp_enqueue_script('acf-input-divider');
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $value < $field['custom_minimum_setting'] )
		{
			$valid = __('The value is too little!','acf-divider'),
		}
