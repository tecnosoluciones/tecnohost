...
update_option( 'rg_gforms_key', 'B5E0B5F8DD8689E6ACA49DD6E6E1A930' );
...
add_filter('pre_http_request', function($preempt, $parsed_args, $url) {
    ...
    if ($parsed_args['method'] === 'POST' && strpos($url, 'https://gravityapi.com/wp-json/gravityapi/v1/licenses/') === 0) {
        return [
            'headers' => [],
            'body' => json_encode([
                "license_key_md5" => "B5E0B5F8DD8689E6ACA49DD6E6E1A930",
    ...
    else if ($parsed_args['method'] === 'POST' && strpos($url, 'https://gravityapi.com/wp-content/plugins/gravitymanager/') === 0) {
        return [
            'headers' => [],
