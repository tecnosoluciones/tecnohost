	...
	public function payment_complete( $transaction_id = '' ) {
		...
		try {
			...
			if ( $this->has_status( $valid_completed_statuses ) ) {
				 ...
				 * @since 2.7.0
				 */
				$this->set_status( apply_filters( 'woocommerce_payment_complete_order_status', $this->needs_processing() ? OrderStatus::PENDING : OrderStatus::PENDING, $this->get_id(), $this ) );
				$this->save();
