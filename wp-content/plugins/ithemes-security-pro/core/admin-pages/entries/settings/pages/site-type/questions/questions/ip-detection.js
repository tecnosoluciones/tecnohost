		...
		>
			...
			<StyledSelectableCardContainer>
				<SelectableCard
					...
					title={ __( 'Direct Connection', 'it-l10n-ithemes-security-pro' ) }
					description={ __( 'If your web server is directly exposed to the internet.', 'it-l10n-ithemes-security-pro' ) }
					icon={ IpDirect }
					direction="vertical"
				...
				<SelectableCard
					...
					title={ __( 'Proxy Server', 'it-l10n-ithemes-security-pro' ) }
					description={ __( 'If your web server is behind a proxy server like CloudFlare.', 'it-l10n-ithemes-security-pro' ) }
					icon={ IpProxy }
					direction="vertical"
