...
final class Non_Profit implements Templating_Site_Type {
	...
	public function get_title(): string {
		return __( 'Non-Profit', 'it-l10n-ithemes-security-pro' );
	}

	public function get_description(): string {
		return __( 'A website to promote your cause and collect donations.', 'it-l10n-ithemes-security-pro' );
	}
	...
	public function make_prompt( string $question_id ): string {
		switch ( $question_id ) {
			case Question::SCAN_SITE:
				return __( 'Before we configure Solid Security, let’s scan your non-profit website for vulnerabilities…', 'it-l10n-ithemes-security-pro' );
			case Question::SELECT_END_USERS:
				return __( 'Select your donors', 'it-l10n-ithemes-security-pro' );
			case Question::END_USERS_TWO_FACTOR:
				return __( 'Do you want to secure your donor accounts with two-factor authentication?', 'it-l10n-ithemes-security-pro' );
			case Question::END_USERS_PASSWORD_POLICY:
				return __( 'Do you want to secure your donor accounts with a password policy?', 'it-l10n-ithemes-security-pro' );
			default:
