...
export default function StellarSale( { installType } ) {
	...
	const subtitle = installType === 'free'
		? __( 'Save 40% on Solid Security Pro.', 'it-l10n-ithemes-security-pro' )
		: __( 'Save 40% on Solid Suite.', 'it-l10n-ithemes-security-pro' );
					...
					{ isSmall && (
						<Text
							...
							text={ createInterpolateElement(
								__( 'Take <b>40%</b> off all StellarWP brands during the annual Stellar Sale. Now through July 30.', 'it-l10n-ithemes-security-pro' ),
								{
									b: <strong />,
								}
							) }
