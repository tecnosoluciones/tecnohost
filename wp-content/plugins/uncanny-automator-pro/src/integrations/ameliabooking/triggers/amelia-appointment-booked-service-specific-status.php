...
/**
 * Class AMELIA_APPOINTMENT_BOOKED_SERVICE_SPECIFIC_STATUS
 *
...
class AMELIA_APPOINTMENT_BOOKED_SERVICE_SPECIFIC_STATUS {
	 ...
	 * @var string
	 */
	const TRIGGER_CODE = 'AMELIA_APPOINTMENT_BOOKED_SERVICE_SPECIFIC_STATUS';
	 ...
	 * @var string
	 */
	const TRIGGER_META = 'AMELIA_APPOINTMENT_BOOKED_SERVICE_SPECIFIC_STATUS_META';
	...
	public function setup_trigger() {
		...
		$this->set_sentence(
			...
			/* Translators: Trigger sentence */
				esc_html__( 'A booking of an appointment for {{a service:%1$s}} has been changed to {{a specific status:%2$s}}', 'uncanny-automator' ),
		...
		/* Translators: Trigger sentence */
			esc_html__( 'A booking of an appointment for {{a service}} has been changed to {{a specific status}}', 'uncanny-automator' )
		);
