    ...
    function init_epayco_woocommerce()
    {
        ...
        class WC_ePayco extends WC_Payment_Gateway
        {
            ...
            public function __construct()
            {
                ...
                add_filter('woocommerce_available_payment_gateways',array( $this, 'filter_gateways_currency' ),1);
