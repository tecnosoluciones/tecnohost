    ...
    <table class="wpacu-form-table">
		...
		<tr valign="top">
			...
			<td>
                ...
                &nbsp;<small>* the individual files will be combined into larger JavaScript files and referenced from <code style="font-size: inherit;"><?php echo '/'.str_replace(Misc::getWpRootDirPath(), '', WP_CONTENT_DIR) . \WpAssetCleanUp\OptimiseAssets\OptimizeCommon::getRelPathPluginCacheDir(); ?>js/</code></small>
