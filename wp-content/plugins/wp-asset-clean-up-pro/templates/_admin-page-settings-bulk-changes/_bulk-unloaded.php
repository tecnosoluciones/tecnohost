...
<nav class="nav-tab-wrapper">
    <a href="<?php echo esc_url(admin_url('admin.php?page=wpassetcleanup_bulk_unloads')); ?>" class="nav-tab <?php if ($data['for'] === 'everywhere') { ?>nav-tab-active<?php } ?>">Everywhere</a>
    ...
    <a href="<?php echo esc_url(admin_url('admin.php?page=wpassetcleanup_bulk_unloads&wpacu_for=authors')); ?>" class="nav-tab <?php if ($data['for'] === 'authors') { ?>nav-tab-active<?php } ?>">Authors</a>
    <a href="<?php echo esc_url(admin_url('admin.php?page=wpassetcleanup_bulk_unloads&wpacu_for=search_results')); ?>" class="nav-tab <?php if ($data['for'] === 'search_results') { ?>nav-tab-active<?php } ?>">Search Results</a>
    <a href="<?php echo esc_url(admin_url('admin.php?page=wpassetcleanup_bulk_unloads&wpacu_for=dates')); ?>" class="nav-tab <?php if ($data['for'] === 'dates') { ?>nav-tab-active<?php } ?>">Dates</a>
    <a href="<?php echo esc_url(admin_url('admin.php?page=wpassetcleanup_bulk_unloads&wpacu_for=404_not_found')); ?>" class="nav-tab <?php if ($data['for'] === '404_not_found') { ?>nav-tab-active<?php } ?>">404 Not Found</a>
</nav>
...
<form action="" method="post">
	...
	if ($data['for'] === 'post_types' && $isCustomPostTypeArchivePageRequest) {
        ...
        <div class="alert">
            <p>This is the list of the assets that are <strong>unloaded</strong> on the archive page (any pagination) belonging to the <strong><u><?php echo esc_html($targetCustomPostType); ?></u></strong> post type. &nbsp;&nbsp;<a id="wpacu-add-bulk-rules-info-target" href="#wpacu-add-bulk-rules-info" style="text-decoration: none;"><span class="dashicons dashicons-info"></span> How the list below gets filled with site-wide rules?</a></p>
	...
	if ($data['for'] === 'taxonomies') {
        ...
        <div class="alert">
            <p>This is the list of the assets that are <strong>unloaded</strong> on all taxonomies pages belonging to the <strong><u><?php echo esc_html($data['taxonomy']); ?></u></strong> type. &nbsp;&nbsp;<a id="wpacu-add-bulk-rules-info-target" href="#wpacu-add-bulk-rules-info" style="text-decoration: none;"><span class="dashicons dashicons-info"></span> How the list below gets filled with site-wide rules?</a></p>
            <p>If you want to make an asset load again, use the "Remove bulk rule" checkbox.</p>
            <div style="margin: 0; background: white; padding: 10px; border: 1px solid #ccc; width: auto; display: inline-block;">
                <ul>
