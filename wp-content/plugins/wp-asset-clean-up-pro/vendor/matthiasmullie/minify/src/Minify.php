...
abstract class Minify
{
     ...
     *
     * @param \PsrWpacu\Cache\CacheItemInterface $item Cache item to write the data to
     *
     * @return \PsrWpacu\Cache\CacheItemInterface Cache item with the minifier data
     */
    public function cache(\PsrWpacu\Cache\CacheItemInterface $item)
    {
