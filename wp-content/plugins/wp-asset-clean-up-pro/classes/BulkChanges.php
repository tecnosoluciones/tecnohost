...
class BulkChanges
{
    ...
    public function pageBulkUnloads()
    {
	    ...
	    if (Misc::getVar('get', 'wpacu_bulk_menu_tab') === 'regex_unloads') {
			...
			*/
	        $this->data['values'] = MainPro::getRegExRules('unloads');
			...
			*/
	        $this->data['values'] = MainPro::getRegExRules('load_exceptions');
        } else {
            /*
	...
	public function noticeTaxonomiesRemoved()
	{
		?>
        <div class="updated notice wpacu-notice is-dismissible">
            <p><span class="dashicons dashicons-yes"></span> The selected styles/scripts were removed from the unload list for <strong><u><?php echo esc_html($this->wpacuTaxonomy); ?></u></strong>
