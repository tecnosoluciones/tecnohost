...
class Due_Date extends \Gravity_Forms\Gravity_Forms\Settings\Fields\Base {
	...
	public function markup() {
        ...
        $checkbox_label = esc_html__( 'Schedule due date', 'gravityflow' );
...
Fields::register( 'due_date', '\Gravity_Flow\Gravity_Flow\Settings\Fields\Due_Date' );
