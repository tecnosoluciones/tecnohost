 ...
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/emails/plain/email-subscription-trial-end-details.php.
 */
...
// translators: placeholder is localised trial end date"
echo sprintf( wp_kses_post( _x( 'Trial End Date: %s', 'in plain emails for subscription information', 'enhancer-for-woocommerce-subscriptions' ) ), esc_html( date_i18n( wc_date_format(), $subscription->get_time( 'trial_end', 'site' ) ) ) ) . "\n" ;
