 ...
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/emails/email-subscription-end-details.php.
 */
	...
	<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="1">
		<thead>
			<tr>
				...
				<th class="td" scope="col" style="text-align:<?php echo esc_attr( $text_align ) ; ?>;"><?php echo esc_html_x( 'End Date', 'table headings in notification email', 'enhancer-for-woocommerce-subscriptions' ) ; ?></th>
			</tr>
		</thead>
		<tbody>
			<tr>
