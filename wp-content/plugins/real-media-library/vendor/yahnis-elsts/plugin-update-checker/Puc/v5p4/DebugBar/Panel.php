...
use MatthiasWeb\RealMediaLibrary\Vendor\YahnisElsts\PluginUpdateChecker\v5p4\UpdateChecker;
if (!\class_exists(Panel::class, \false) && \class_exists('MatthiasWeb\\RealMediaLibrary\\Vendor\\Debug_Bar_Panel', \false)) {
    /** @internal */
    class Panel extends \MatthiasWeb\RealMediaLibrary\Vendor\Debug_Bar_Panel
    {
        /** @var UpdateChecker */
