    ...
    abstract class UpdateChecker
    {
        ...
        public function triggerError($message, $errorType)
        {
            if ($this->isDebugModeEnabled()) {
                ...
                \trigger_error(\esc_html($message), $errorType);
            }
        }
        /**
         * @return bool
        ...
        {
            if (\class_exists('MatthiasWeb\\RealMediaLibrary\\Vendor\\Debug_Bar', \false) && \class_exists('MatthiasWeb\\RealMediaLibrary\\Vendor\\Debug_Bar_Panel', \false) && \file_exists(\dirname(__FILE__) . '/DebugBar')) {
