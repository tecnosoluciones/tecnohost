...
use MatthiasWeb\RealMediaLibrary\Vendor\Parsedown;
use MatthiasWeb\RealMediaLibrary\Vendor\PucReadmeParser;
if (!\class_exists(Api::class, \false)) {
    ...
    abstract class Api
    {
         ...
         */
        protected abstract function getUpdateDetectionStrategies($configBranch);
        /**
