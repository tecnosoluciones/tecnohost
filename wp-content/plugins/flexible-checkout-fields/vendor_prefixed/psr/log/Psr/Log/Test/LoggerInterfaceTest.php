...
namespace FcfVendor\Psr\Log\Test;

use FcfVendor\Psr\Log\LoggerInterface;
use FcfVendor\Psr\Log\LogLevel;
use FcfVendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('FcfVendor\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('FcfVendor\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('FcfVendor\Psr\Log\Test\DummyTest', array('__toString'));
        }
