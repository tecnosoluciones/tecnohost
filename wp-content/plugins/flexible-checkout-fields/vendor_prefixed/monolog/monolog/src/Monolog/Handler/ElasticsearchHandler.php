...
use FcfVendor\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use FcfVendor\Monolog\Logger;
use FcfVendor\Monolog\Formatter\FormatterInterface;
use FcfVendor\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use FcfVendor\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use FcfVendor\Elasticsearch\Client;
use FcfVendor\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use FcfVendor\Elastic\Elasticsearch\Client as Client8;
/**
