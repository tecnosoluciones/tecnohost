 ...
 * MainWP Branding extension handler.
 */
class MainWP_Child_Branding { //phpcs:ignore -- NOSONAR - multi methods.
     ...
     */
    public function branding_init() { // phpcs:ignore -- NOSONAR - complex.
    ...
    public function custom_admin_css() {
        ...
        if ( ! empty( $header_css ) ) {
            echo '<style>' . static::parse_css( $header_css ) . '</style>'; // phpcs:ignore WordPress.Security.EscapeOutput
        }
    }
    ...
    public function custom_login_css() {
        ...
        if ( isset( $extra_setting['login_css'] ) && ! empty( $extra_setting['login_css'] ) ) {
            echo '<style>' . static::parse_css( $extra_setting['login_css'] ) . '</style>'; // phpcs:ignore WordPress.Security.EscapeOutput
        }
    }
