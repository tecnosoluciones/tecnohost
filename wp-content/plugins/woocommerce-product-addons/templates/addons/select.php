...
$isSelectDomain = ( $addon['name'] == 'Selector Dominios' ) ? true : false;

?>
<div class="form-row form-row-wide wc-pao-addon-wrap wc-pao-addon-<?php echo esc_attr( sanitize_title( $field_name ) ); ?> <?php echo $isSelectDomain ? "wc-pao-addon-selector-dominios" : ""; ?>">
	<select
