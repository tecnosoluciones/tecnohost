...
final class Wicked_Folders {
    ...
    private function __construct() {
		...
		add_action( 'pre_get_posts', 	array( $this, 'pre_get_posts' ), 20 ); // Must be called after pre_get_posts action in Wicked_Folders\Admin
    ...
    public static function autoload( $class ) {
        ...
        $file 	= false;
        $files  = array(
			'Wicked_Folders\Screen_State' 					=> 'classes/class-screen-state.php',
			'Wicked_Folders\Admin' 							=> 'classes/class-admin.php',
			'Wicked_Folders\Folder' 						=> 'classes/class-folder.php',
			'Wicked_Folders\Tree_View' 						=> 'classes/class-tree-view.php',
			'Wicked_Folders\Term_Folder' 					=> 'classes/class-term-folder.php',
			'Wicked_Folders\Dynamic_Folder'   				=> 'classes/class-dynamic-folder.php',
			'Wicked_Folders\Author_Dynamic_Folder'  		=> 'classes/class-author-dynamic-folder.php',
			'Wicked_Folders\Date_Dynamic_Folder'   			=> 'classes/class-date-dynamic-folder.php',
			'Wicked_Folders\Term_Dynamic_Folder'   			=> 'classes/class-term-dynamic-folder.php',
			'Wicked_Folders\Common' 						=> 'classes/class-common.php',
			'Wicked_Folders\Unassigned_Dynamic_Folder' 		=> 'classes/class-unassigned-dynamic-folder.php',
			'Wicked_Folders\Post_Hierarchy_Dynamic_Folder' 	=> 'classes/class-post-hierarchy-dynamic-folder.php',
			'Wicked_Folders\Object_Collection' 				=> 'classes/class-object-collection.php',
			'Wicked_Folders\Folder_Collection' 				=> 'classes/class-folder-collection.php',
			'Wicked_Folders\JSON_Serializable_Object' 		=> 'classes/class-json-serializable-object.php',
			'Wicked_Folders\Singleton' 						=> 'classes/class-singleton.php',
			'Wicked_Folders\Folder_Factory' 				=> 'classes/class-folder-factory.php',
			'Wicked_Folders\REST_API\v1\REST_API' 			=> 'classes/rest-api/v1/class-rest-api.php',
			'Wicked_Folders\REST_API\v1\Folder_API' 		=> 'classes/rest-api/v1/class-folder-api.php',
			'Wicked_Folders\REST_API\v1\Screen_State_API' 	=> 'classes/rest-api/v1/class-screen-state-api.php',
        );
    ...
    public static function get_folders( $post_type, $taxonomy = false ) {
		...
		// Unassigned folder
		$unassigned_items = new Unassigned_Dynamic_Folder( array(
	 ...
	 *
	 * @return array
	 *  Array of Date_Dynamic_Folder objects.
	 */
	public function get_date_dynamic_folders( $post_type, $taxonomy ) {
		...
		$folders[] = new Date_Dynamic_Folder( array(
				'id' 		=> 'dynamic_date',
	 ...
	 *
	 * @return array
	 *  Array of Author_Dynamic_Folder objects.
	 */
	public function get_author_dynamic_folders( $post_type, $taxonomy ) {
		...
		$folders[] = new Author_Dynamic_Folder( array(
				'id' 		=> 'dynamic_author',
		...
		if ( is_array( $taxonomies ) ) {
			foreach ( $taxonomies as $taxonomy ) {
				...
				if ( ! is_wp_error( $terms ) && ! empty( $terms ) ) {
					...
					$term_folders[] = new Term_Dynamic_Folder( array(
	 ...
	 *
	 * @return array
	 *  Array of Wicked_Folders\Post_Hierarchy_Dynamic_Folder objects.
	 */
	public function get_post_hiearchy_dynamic_folders( $post_type, $taxonomy ) {
		...
		if ( $post_type ) {
			if ( isset( $post_type->hierarchical ) && true == $post_type->hierarchical ) {
				$folders[] = new Post_Hierarchy_Dynamic_Folder( array(
	 ...
	 *
	 * @return Wicked_Folders\Dynamic_Folder|bool
	...
	public static function get_dynamic_folder( $class, $id, $post_type, $taxonomy = false ) {
		...
		if ( is_a( $folder, 'Wicked_Folders\Dynamic_Folder' ) ) {
			$folder->type = get_class( $folder );
			return $folder;
		} else {
			return false;
	...
	private function apply_folder_order( WP_Query $query ) {
		...
		if ( $meta_key ) {
			...
			Common::array_insert_after_key( $orderby, 'wicked_folder_order', $a );
