...
<div class="wrap">
	...
	<h2><span class="pciwgas-sf-blue">Post Category Image </span>Including in <span class="pciwgas-sf-blue">Essential Plugin Bundle</span></h2>
		...
		<div id="post-body" class="metabox-holder">
			<div id="post-body-content">
				<div style="text-align: center; background: #DCDCDC; margin: 30px 0; padding: 10px 30px 30px 30px;">
					...
					<a href="<?php echo esc_url( PCIWGAS_PLUGIN_UPGRADE ); ?>" target="_blank" class="pciwgas-sf-btn pciwgas-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle</a>
				</div>
				...
				<div style="text-align: center; margin-bottom:30px">
					<h3 class="pciwgas-sf-blue" style="margin:0; margin-bottom:10px; font-size:24px; font-weight:bold;">Use Essential Plugin Bundle</h3>
				...
				<div style="text-align: center;">
					<img style="width: 100%; margin-bottom:30px;" src="<?php echo esc_url( PCIWGAS_URL ); ?>assets/images/image-upgrade.png" alt="image-upgrade" title="image-upgrade" />
					<div style="font-size: 14px; margin-bottom:10px;"><span class="pciwgas-sf-blue">Post Category </span>Including in <span class="pciwgas-sf-blue">Essential Plugin Bundle</span></div>
					<a href="<?php echo esc_url( PCIWGAS_PLUGIN_UPGRADE ); ?>" target="_blank" class="pciwgas-sf-btn pciwgas-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Bundle Deal</a>
				</div>
			</div>
		</div>
	</div>
