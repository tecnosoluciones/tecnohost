...
<div class="sub_titu">
    <h2 id="subscription_name">
        <?php echo esc_html( wcs_get_subscription_status_name( $product_name ) ); ?>
    </h2>
</div>

<div class="mensaje_pd">
    <p>
        <strong>NOTA IMPORTANTE</strong>: Estimado cliente, por favor tenga en cuenta que el precio que aparece en su Pedido/Suscripción es el precio del momento en el que realizo su compra.
        En el caso de que los precios hayan cambiado, lo podrá ver reflejado en los emails y pedidos de renovación correspondientes. Vale decir que puede verificar
        nuestros precios actuales en <a href='https://tecnohost.net/dominios' target='_blank'>tecnohost.net</a>.
    </p>
</div>
...
<table class="shop_table subscription_details">
	<tbody>
        <tr>
            <td><?php esc_html_e( 'Subscription', 'woocommerce-subscriptions' ); ?></td>
            <td><?php echo esc_html( sprintf( _x( '#%s', 'hash before order number', 'woocommerce-subscriptions' ), $subscription->get_order_number() ) ); ?></td>
        </tr>
		<tr>
