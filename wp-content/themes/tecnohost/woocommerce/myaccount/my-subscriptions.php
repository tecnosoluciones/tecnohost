...
<div class="woocommerce_account_subscriptions">
	...
	<thead>
		<tr>
			...
			<th class="subscription-name order-name woocommerce-orders-table__header woocommerce-orders-table__header-order-name woocommerce-orders-table__header-subscription-name"><span class="nobr"><?php esc_html_e( 'Subscription Name', 'woocommerce-subscriptions' ); ?></span></th>
	...
	<?php foreach ( $subscriptions as $subscription_id => $subscription ) :
		...
		<tr class="order woocommerce-orders-table__row woocommerce-orders-table__row--status-<?php echo esc_attr( $subscription->get_status() ); ?>">
            ...
            <td class="subscription-suscription_name order-suscription_name woocommerce-orders-table__cell woocommerce-orders-table__cell-subscription-suscription_name woocommerce-orders-table__cell-order-suscription_name" data-title="<?php esc_attr_e( 'ID', 'woocommerce-subscriptions' ); ?>">
                <?php echo esc_attr( wcs_get_subscription_status_name( $product_name ) ); ?>
                <span id="domn"><?php echo esc_attr( wcs_get_subscription_status_name( $dom_dat ) ); ?></span>
            </td>
