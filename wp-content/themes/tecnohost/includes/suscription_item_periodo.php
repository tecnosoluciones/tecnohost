 ...
 */
class Get_periodo_item extends AutomateWoo\Variable {
    ...
    public function get_value( $order, $parameters ) {
        ...
        if(get_post_meta($order->get_id(), '_billing_period', true) == "month"){
            $periodo_servicio = "Mensual";
        }
        else{
            $periodo_servicio = "Anual";
        }
        return $periodo_servicio;
    }
}

return new Get_periodo_item();