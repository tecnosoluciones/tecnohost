 ...
 */
class Get_hosting_ancho_banda extends AutomateWoo\Variable {
    ...
    public function get_value( $order, $parameters ) {
        ...
        foreach($order->get_items() AS $key => $value){
            $producto =  wc_get_product($value->get_data()['product_id']);
            $respuesta = $producto->get_attribute('trafico-mes-gb');
            break;
        }
...
return new Get_hosting_ancho_banda();